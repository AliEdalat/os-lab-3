...
80100508:	e8 23 68 00 00       	call   80106d30 <uartputc>
8010050d:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100514:	e8 17 68 00 00       	call   80106d30 <uartputc>
80100519:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100520:	e8 0b 68 00 00       	call   80106d30 <uartputc>
...
801005f0:	e8 3b 67 00 00       	call   80106d30 <uartputc>
...
80100c12:	75 d2                	jne    80100be6 <exec+0x56>
  ...
  if((pgdir = setupkvm()) == 0)
80100c14:	e8 a7 72 00 00       	call   80107ec0 <setupkvm>
...
80100ca4:	e8 67 70 00 00       	call   80107d10 <allocuvm>
...
80100cda:	e8 71 6f 00 00       	call   80107c50 <loaduvm>
...
80100cf9:	e8 42 71 00 00       	call   80107e40 <freevm>
...
80100d35:	e8 d6 6f 00 00       	call   80107d10 <allocuvm>
...
80100d4c:	e8 ef 70 00 00       	call   80107e40 <freevm>
...
80100d91:	e8 ca 71 00 00       	call   80107f60 <clearpteu>
  sp = sz;
...
80100df1:	e8 da 72 00 00       	call   801080d0 <copyout>
...
80100e55:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100e5b:	e8 70 72 00 00       	call   801080d0 <copyout>
...
80100ecc:	e8 ef 6b 00 00       	call   80107ac0 <switchuvm>
  freevm(oldpgdir);
80100ed1:	89 3c 24             	mov    %edi,(%esp)
80100ed4:	e8 67 6f 00 00       	call   80107e40 <freevm>
  return 0;
...
80102fc2:	e8 b9 39 00 00       	call   80106980 <idtinit>
...
80102fe3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102fe6:	e8 b5 4a 00 00       	call   80107aa0 <switchkvm>
  seginit();
80102feb:	e8 b0 49 00 00       	call   801079a0 <seginit>
  lapicinit();
...
80103049:	e8 22 3c 00 00       	call   80106c70 <uartinit>
  pinit();         // process table
8010304e:	e8 3d 08 00 00       	call   80103890 <pinit>
  tvinit();        // trap vectors
80103053:	e8 88 38 00 00       	call   801068e0 <tvinit>
  binit();         // buffer cache
...
801037e7:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801037ea:	c7 40 14 c7 68 10 80 	movl   $0x801068c7,0x14(%eax)
...
80103993:	e8 28 45 00 00       	call   80107ec0 <setupkvm>
...
801039b1:	e8 1a 42 00 00       	call   80107bd0 <inituvm>
  p->sz = PGSIZE;
...
80103a9e:	e8 6d 42 00 00       	call   80107d10 <allocuvm>
...
80103ab0:	e8 0b 40 00 00       	call   80107ac0 <switchuvm>
  return 0;
...
80103ad4:	e8 37 43 00 00       	call   80107e10 <deallocuvm>
...
80103b28:	e8 63 44 00 00       	call   80107f90 <copyuvm>
...
80103c6e:	81 c3 60 06 00 00    	add    $0x660,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103c74:	e8 47 3e 00 00       	call   80107ac0 <switchuvm>
      p->state = RUNNING;
...
80103c8c:	e8 7a 12 00 00       	call   80104f0b <swtch>
      switchkvm();
80103c91:	e8 0a 3e 00 00       	call   80107aa0 <switchkvm>
...
80104068:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010406f:	e8 cc 3d 00 00       	call   80107e40 <freevm>
        p->pid = 0;
...
80106740:	c7 04 24 80 e5 12 80 	movl   $0x8012e580,(%esp)
...
sys_ticketlocktest(void)
{
  ticket_acquire(&ticketlock);
  safe_count++;
80106747:	83 05 bc c5 10 80 01 	addl   $0x1,0x8010c5bc
  ticket_release(&ticketlock);
8010674e:	e8 9d e4 ff ff       	call   80104bf0 <ticket_release>
}
...
80106763:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80106766:	e8 e5 d1 ff ff       	call   80103950 <myproc>
8010676b:	8b 40 10             	mov    0x10(%eax),%eax
}
8010676e:	c9                   	leave  
8010676f:	c3                   	ret    
...
8010677d:	e8 3e e8 ff ff       	call   80104fc0 <argint>
80106782:	83 c4 10             	add    $0x10,%esp
80106785:	85 c0                	test   %eax,%eax
80106787:	78 27                	js     801067b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80106789:	e8 c2 d1 ff ff       	call   80103950 <myproc>
  if(growproc(n) < 0)
8010678e:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = myproc()->sz;
80106791:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80106793:	ff 75 f4             	pushl  -0xc(%ebp)
80106796:	e8 d5 d2 ff ff       	call   80103a70 <growproc>
8010679b:	83 c4 10             	add    $0x10,%esp
8010679e:	85 c0                	test   %eax,%eax
801067a0:	78 0e                	js     801067b0 <sys_sbrk+0x40>
    return -1;
  return addr;
...
801067b5:	eb ed                	jmp    801067a4 <sys_sbrk+0x34>
...
801067cd:	e8 ee e7 ff ff       	call   80104fc0 <argint>
801067d2:	83 c4 10             	add    $0x10,%esp
801067d5:	85 c0                	test   %eax,%eax
801067d7:	0f 88 8a 00 00 00    	js     80106867 <sys_sleep+0xa7>
    return -1;
  acquire(&tickslock);
801067dd:	83 ec 0c             	sub    $0xc,%esp
801067e0:	68 e0 e5 12 80       	push   $0x8012e5e0
801067e5:	e8 46 e2 ff ff       	call   80104a30 <acquire>
  ticks0 = ticks;
...
801067ed:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801067f0:	8b 1d 20 ee 12 80    	mov    0x8012ee20,%ebx
  while(ticks - ticks0 < n){
801067f6:	85 d2                	test   %edx,%edx
801067f8:	75 27                	jne    80106821 <sys_sleep+0x61>
801067fa:	eb 54                	jmp    80106850 <sys_sleep+0x90>
...
80106803:	68 e0 e5 12 80       	push   $0x8012e5e0
80106808:	68 20 ee 12 80       	push   $0x8012ee20
8010680d:	e8 fe d6 ff ff       	call   80103f10 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106812:	a1 20 ee 12 80       	mov    0x8012ee20,%eax
80106817:	83 c4 10             	add    $0x10,%esp
8010681a:	29 d8                	sub    %ebx,%eax
8010681c:	3b 45 f4             	cmp    -0xc(%ebp),%eax
8010681f:	73 2f                	jae    80106850 <sys_sleep+0x90>
    if(myproc()->killed){
80106821:	e8 2a d1 ff ff       	call   80103950 <myproc>
80106826:	8b 40 24             	mov    0x24(%eax),%eax
80106829:	85 c0                	test   %eax,%eax
8010682b:	74 d3                	je     80106800 <sys_sleep+0x40>
      release(&tickslock);
8010682d:	83 ec 0c             	sub    $0xc,%esp
80106830:	68 e0 e5 12 80       	push   $0x8012e5e0
80106835:	e8 a6 e2 ff ff       	call   80104ae0 <release>
      return -1;
...
80106853:	68 e0 e5 12 80       	push   $0x8012e5e0
80106858:	e8 83 e2 ff ff       	call   80104ae0 <release>
  return 0;
8010685d:	83 c4 10             	add    $0x10,%esp
80106860:	31 c0                	xor    %eax,%eax
}
80106862:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106865:	c9                   	leave  
80106866:	c3                   	ret    
{
  int n;
...
8010686c:	eb d4                	jmp    80106842 <sys_sleep+0x82>
...
80106874:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80106877:	68 e0 e5 12 80       	push   $0x8012e5e0
8010687c:	e8 af e1 ff ff       	call   80104a30 <acquire>
  xticks = ticks;
80106881:	8b 1d 20 ee 12 80    	mov    0x8012ee20,%ebx
  release(&tickslock);
80106887:	c7 04 24 e0 e5 12 80 	movl   $0x8012e5e0,(%esp)
8010688e:	e8 4d e2 ff ff       	call   80104ae0 <release>
  return xticks;
}
80106893:	89 d8                	mov    %ebx,%eax
80106895:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80106898:	c9                   	leave  
80106899:	c3                   	ret    
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801068a1:	ba f4 00 00 00       	mov    $0xf4,%edx
801068a6:	31 c0                	xor    %eax,%eax
801068a8:	89 e5                	mov    %esp,%ebp
801068aa:	ee                   	out    %al,(%dx)
  outb(0xf4, 0x00);
  return 0;
}
...
801068b0:	06                   	push   %es
  pushl %fs
801068b1:	0f a0                	push   %fs
  pushl %gs
801068b3:	0f a8                	push   %gs
  pushal
801068b5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801068b6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801068ba:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801068bc:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801068be:	54                   	push   %esp
  call trap
801068bf:	e8 ec 00 00 00       	call   801069b0 <trap>
  addl $4, %esp
801068c4:	83 c4 04             	add    $0x4,%esp
...
801068c7:	61                   	popa   
  popl %gs
801068c8:	0f a9                	pop    %gs
  popl %fs
801068ca:	0f a1                	pop    %fs
  popl %es
801068cc:	07                   	pop    %es
  popl %ds
801068cd:	1f                   	pop    %ds
...
801068d4:	66 90                	xchg   %ax,%ax
801068d6:	66 90                	xchg   %ax,%ax
801068d8:	66 90                	xchg   %ax,%ax
801068da:	66 90                	xchg   %ax,%ax
801068dc:	66 90                	xchg   %ax,%ax
...
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
801068e0:	31 c0                	xor    %eax,%eax
801068e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801068e8:	8b 14 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%edx
801068ef:	b9 08 00 00 00       	mov    $0x8,%ecx
801068f4:	c6 04 c5 24 e6 12 80 	movb   $0x0,-0x7fed19dc(,%eax,8)
801068fb:	00 
801068fc:	66 89 0c c5 22 e6 12 	mov    %cx,-0x7fed19de(,%eax,8)
80106903:	80 
80106904:	c6 04 c5 25 e6 12 80 	movb   $0x8e,-0x7fed19db(,%eax,8)
8010690b:	8e 
8010690c:	66 89 14 c5 20 e6 12 	mov    %dx,-0x7fed19e0(,%eax,8)
80106913:	80 
80106914:	c1 ea 10             	shr    $0x10,%edx
80106917:	66 89 14 c5 26 e6 12 	mov    %dx,-0x7fed19da(,%eax,8)
8010691e:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
8010691f:	83 c0 01             	add    $0x1,%eax
80106922:	3d 00 01 00 00       	cmp    $0x100,%eax
80106927:	75 bf                	jne    801068e8 <tvinit+0x8>
...
8010692a:	ba 08 00 00 00       	mov    $0x8,%edx
struct spinlock tickslock;
uint ticks;
...
80106931:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106934:	a1 08 c1 10 80       	mov    0x8010c108,%eax

  initlock(&tickslock, "time");
80106939:	68 15 8b 10 80       	push   $0x80108b15
8010693e:	68 e0 e5 12 80       	push   $0x8012e5e0
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106943:	66 89 15 22 e8 12 80 	mov    %dx,0x8012e822
8010694a:	c6 05 24 e8 12 80 00 	movb   $0x0,0x8012e824
80106951:	66 a3 20 e8 12 80    	mov    %ax,0x8012e820
80106957:	c1 e8 10             	shr    $0x10,%eax
8010695a:	c6 05 25 e8 12 80 ef 	movb   $0xef,0x8012e825
80106961:	66 a3 26 e8 12 80    	mov    %ax,0x8012e826

  initlock(&tickslock, "time");
80106967:	e8 64 df ff ff       	call   801048d0 <initlock>
}
8010696c:	83 c4 10             	add    $0x10,%esp
8010696f:	c9                   	leave  
80106970:	c3                   	ret    
80106971:	eb 0d                	jmp    80106980 <idtinit>
80106973:	90                   	nop
80106974:	90                   	nop
80106975:	90                   	nop
80106976:	90                   	nop
...
8010698b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010698f:	b8 20 e6 12 80       	mov    $0x8012e620,%eax
...
801069b9:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(tf->trapno == T_SYSCALL){
801069bc:	8b 47 30             	mov    0x30(%edi),%eax
801069bf:	83 f8 40             	cmp    $0x40,%eax
801069c2:	0f 84 88 01 00 00    	je     80106b50 <trap+0x1a0>
    if(myproc()->killed)
      exit();
    return;
  }
...
801069ce:	77 10                	ja     801069e0 <trap+0x30>
801069d0:	ff 24 85 98 8e 10 80 	jmp    *-0x7fef7168(,%eax,4)
...
801069e0:	e8 6b cf ff ff       	call   80103950 <myproc>
801069e5:	85 c0                	test   %eax,%eax
801069e7:	0f 84 d7 01 00 00    	je     80106bc4 <trap+0x214>
801069ed:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801069f1:	0f 84 cd 01 00 00    	je     80106bc4 <trap+0x214>
...
801069fa:	8b 57 38             	mov    0x38(%edi),%edx
801069fd:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80106a00:	89 55 dc             	mov    %edx,-0x24(%ebp)
80106a03:	e8 28 cf ff ff       	call   80103930 <cpuid>
80106a08:	8b 77 34             	mov    0x34(%edi),%esi
80106a0b:	8b 5f 30             	mov    0x30(%edi),%ebx
80106a0e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106a11:	e8 3a cf ff ff       	call   80103950 <myproc>
80106a16:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106a19:	e8 32 cf ff ff       	call   80103950 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a1e:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80106a21:	8b 55 dc             	mov    -0x24(%ebp),%edx
80106a24:	51                   	push   %ecx
80106a25:	52                   	push   %edx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106a26:	8b 55 e0             	mov    -0x20(%ebp),%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a29:	ff 75 e4             	pushl  -0x1c(%ebp)
80106a2c:	56                   	push   %esi
80106a2d:	53                   	push   %ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80106a2e:	83 c2 6c             	add    $0x6c,%edx
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
80106a32:	ff 70 10             	pushl  0x10(%eax)
80106a35:	68 54 8e 10 80       	push   $0x80108e54
80106a3a:	e8 a1 9c ff ff       	call   801006e0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80106a3f:	83 c4 20             	add    $0x20,%esp
80106a42:	e8 09 cf ff ff       	call   80103950 <myproc>
80106a47:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
...
80106a50:	e8 fb ce ff ff       	call   80103950 <myproc>
80106a55:	85 c0                	test   %eax,%eax
80106a57:	74 0c                	je     80106a65 <trap+0xb5>
80106a59:	e8 f2 ce ff ff       	call   80103950 <myproc>
80106a5e:	8b 50 24             	mov    0x24(%eax),%edx
80106a61:	85 d2                	test   %edx,%edx
80106a63:	75 4b                	jne    80106ab0 <trap+0x100>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80106a65:	e8 e6 ce ff ff       	call   80103950 <myproc>
80106a6a:	85 c0                	test   %eax,%eax
80106a6c:	74 0b                	je     80106a79 <trap+0xc9>
80106a6e:	e8 dd ce ff ff       	call   80103950 <myproc>
80106a73:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80106a77:	74 4f                	je     80106ac8 <trap+0x118>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106a79:	e8 d2 ce ff ff       	call   80103950 <myproc>
80106a7e:	85 c0                	test   %eax,%eax
80106a80:	74 1d                	je     80106a9f <trap+0xef>
80106a82:	e8 c9 ce ff ff       	call   80103950 <myproc>
80106a87:	8b 40 24             	mov    0x24(%eax),%eax
80106a8a:	85 c0                	test   %eax,%eax
80106a8c:	74 11                	je     80106a9f <trap+0xef>
80106a8e:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80106a92:	83 e0 03             	and    $0x3,%eax
80106a95:	66 83 f8 03          	cmp    $0x3,%ax
80106a99:	0f 84 da 00 00 00    	je     80106b79 <trap+0x1c9>
    exit();
}
...
80106aa9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106ab0:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80106ab4:	83 e0 03             	and    $0x3,%eax
80106ab7:	66 83 f8 03          	cmp    $0x3,%ax
80106abb:	75 a8                	jne    80106a65 <trap+0xb5>
    exit();
80106abd:	e8 ce d2 ff ff       	call   80103d90 <exit>
80106ac2:	eb a1                	jmp    80106a65 <trap+0xb5>
80106ac4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80106ac8:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
80106acc:	75 ab                	jne    80106a79 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80106ace:	e8 ed d3 ff ff       	call   80103ec0 <yield>
80106ad3:	eb a4                	jmp    80106a79 <trap+0xc9>
80106ad5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80106ad8:	e8 53 ce ff ff       	call   80103930 <cpuid>
80106add:	85 c0                	test   %eax,%eax
80106adf:	0f 84 ab 00 00 00    	je     80106b90 <trap+0x1e0>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80106ae5:	e8 c6 bd ff ff       	call   801028b0 <lapiceoi>
    break;
80106aea:	e9 61 ff ff ff       	jmp    80106a50 <trap+0xa0>
80106aef:	90                   	nop
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106af0:	e8 7b bc ff ff       	call   80102770 <kbdintr>
    lapiceoi();
80106af5:	e8 b6 bd ff ff       	call   801028b0 <lapiceoi>
    break;
80106afa:	e9 51 ff ff ff       	jmp    80106a50 <trap+0xa0>
80106aff:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106b00:	e8 5b 02 00 00       	call   80106d60 <uartintr>
    lapiceoi();
80106b05:	e8 a6 bd ff ff       	call   801028b0 <lapiceoi>
    break;
80106b0a:	e9 41 ff ff ff       	jmp    80106a50 <trap+0xa0>
80106b0f:	90                   	nop
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106b10:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80106b14:	8b 77 38             	mov    0x38(%edi),%esi
80106b17:	e8 14 ce ff ff       	call   80103930 <cpuid>
80106b1c:	56                   	push   %esi
80106b1d:	53                   	push   %ebx
80106b1e:	50                   	push   %eax
80106b1f:	68 fc 8d 10 80       	push   $0x80108dfc
80106b24:	e8 b7 9b ff ff       	call   801006e0 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80106b29:	e8 82 bd ff ff       	call   801028b0 <lapiceoi>
    break;
80106b2e:	83 c4 10             	add    $0x10,%esp
80106b31:	e9 1a ff ff ff       	jmp    80106a50 <trap+0xa0>
...
80106b39:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106b40:	e8 ab b6 ff ff       	call   801021f0 <ideintr>
80106b45:	eb 9e                	jmp    80106ae5 <trap+0x135>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80106b50:	e8 fb cd ff ff       	call   80103950 <myproc>
80106b55:	8b 58 24             	mov    0x24(%eax),%ebx
80106b58:	85 db                	test   %ebx,%ebx
80106b5a:	75 2c                	jne    80106b88 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
80106b5c:	e8 ef cd ff ff       	call   80103950 <myproc>
80106b61:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80106b64:	e8 87 eb ff ff       	call   801056f0 <syscall>
    if(myproc()->killed)
80106b69:	e8 e2 cd ff ff       	call   80103950 <myproc>
80106b6e:	8b 48 24             	mov    0x24(%eax),%ecx
80106b71:	85 c9                	test   %ecx,%ecx
80106b73:	0f 84 26 ff ff ff    	je     80106a9f <trap+0xef>
    yield();
...
80106b7f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80106b80:	e9 0b d2 ff ff       	jmp    80103d90 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80106b88:	e8 03 d2 ff ff       	call   80103d90 <exit>
80106b8d:	eb cd                	jmp    80106b5c <trap+0x1ac>
80106b8f:	90                   	nop
  }
...
80106b93:	68 e0 e5 12 80       	push   $0x8012e5e0
80106b98:	e8 93 de ff ff       	call   80104a30 <acquire>
      ticks++;
      wakeup(&ticks);
80106b9d:	c7 04 24 20 ee 12 80 	movl   $0x8012ee20,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80106ba4:	83 05 20 ee 12 80 01 	addl   $0x1,0x8012ee20
      wakeup(&ticks);
80106bab:	e8 20 d5 ff ff       	call   801040d0 <wakeup>
      release(&tickslock);
80106bb0:	c7 04 24 e0 e5 12 80 	movl   $0x8012e5e0,(%esp)
80106bb7:	e8 24 df ff ff       	call   80104ae0 <release>
80106bbc:	83 c4 10             	add    $0x10,%esp
80106bbf:	e9 21 ff ff ff       	jmp    80106ae5 <trap+0x135>
80106bc4:	0f 20 d6             	mov    %cr2,%esi
  ...
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106bc7:	8b 5f 38             	mov    0x38(%edi),%ebx
80106bca:	e8 61 cd ff ff       	call   80103930 <cpuid>
80106bcf:	83 ec 0c             	sub    $0xc,%esp
80106bd2:	56                   	push   %esi
80106bd3:	53                   	push   %ebx
80106bd4:	50                   	push   %eax
80106bd5:	ff 77 30             	pushl  0x30(%edi)
80106bd8:	68 20 8e 10 80       	push   $0x80108e20
80106bdd:	e8 fe 9a ff ff       	call   801006e0 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80106be2:	83 c4 14             	add    $0x14,%esp
80106be5:	68 f6 8d 10 80       	push   $0x80108df6
80106bea:	e8 81 97 ff ff       	call   80100370 <panic>
80106bef:	90                   	nop
...
{
  if(!uart)
80106bf0:	a1 c0 c5 10 80       	mov    0x8010c5c0,%eax
  outb(COM1+0, c);
}
...
80106bfa:	74 1c                	je     80106c18 <uartgetc+0x28>
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106bfc:	ba fd 03 00 00       	mov    $0x3fd,%edx
80106c01:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80106c02:	a8 01                	test   $0x1,%al
80106c04:	74 12                	je     80106c18 <uartgetc+0x28>
80106c06:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106c0b:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80106c0c:	0f b6 c0             	movzbl %al,%eax
}
80106c0f:	5d                   	pop    %ebp
80106c10:	c3                   	ret    
...
80106c26:	89 c7                	mov    %eax,%edi
80106c28:	bb 80 00 00 00       	mov    $0x80,%ebx
80106c2d:	be fd 03 00 00       	mov    $0x3fd,%esi
80106c32:	83 ec 0c             	sub    $0xc,%esp
80106c35:	eb 1b                	jmp    80106c52 <uartputc.part.0+0x32>
...
80106c43:	6a 0a                	push   $0xa
80106c45:	e8 86 bc ff ff       	call   801028d0 <microdelay>
{
  int i;
...
80106c4d:	83 eb 01             	sub    $0x1,%ebx
80106c50:	74 07                	je     80106c59 <uartputc.part.0+0x39>
80106c52:	89 f2                	mov    %esi,%edx
80106c54:	ec                   	in     (%dx),%al
80106c55:	a8 20                	test   $0x20,%al
80106c57:	74 e7                	je     80106c40 <uartputc.part.0+0x20>
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106c59:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106c5e:	89 f8                	mov    %edi,%eax
...
80106c73:	89 c8                	mov    %ecx,%eax
80106c75:	89 e5                	mov    %esp,%ebp
80106c77:	57                   	push   %edi
80106c78:	56                   	push   %esi
80106c79:	53                   	push   %ebx
80106c7a:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80106c7f:	89 da                	mov    %ebx,%edx
80106c81:	83 ec 0c             	sub    $0xc,%esp
80106c84:	ee                   	out    %al,(%dx)
80106c85:	bf fb 03 00 00       	mov    $0x3fb,%edi
80106c8a:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80106c8f:	89 fa                	mov    %edi,%edx
80106c91:	ee                   	out    %al,(%dx)
80106c92:	b8 0c 00 00 00       	mov    $0xc,%eax
80106c97:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106c9c:	ee                   	out    %al,(%dx)
80106c9d:	be f9 03 00 00       	mov    $0x3f9,%esi
80106ca2:	89 c8                	mov    %ecx,%eax
80106ca4:	89 f2                	mov    %esi,%edx
80106ca6:	ee                   	out    %al,(%dx)
80106ca7:	b8 03 00 00 00       	mov    $0x3,%eax
80106cac:	89 fa                	mov    %edi,%edx
80106cae:	ee                   	out    %al,(%dx)
80106caf:	ba fc 03 00 00       	mov    $0x3fc,%edx
80106cb4:	89 c8                	mov    %ecx,%eax
80106cb6:	ee                   	out    %al,(%dx)
80106cb7:	b8 01 00 00 00       	mov    $0x1,%eax
...
inb(ushort port)
{
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106cbf:	ba fd 03 00 00       	mov    $0x3fd,%edx
80106cc4:	ec                   	in     (%dx),%al
  ...
  if(inb(COM1+5) == 0xFF)
80106cc5:	3c ff                	cmp    $0xff,%al
80106cc7:	74 5a                	je     80106d23 <uartinit+0xb3>
    return;
  uart = 1;
80106cc9:	c7 05 c0 c5 10 80 01 	movl   $0x1,0x8010c5c0
80106cd0:	00 00 00 
80106cd3:	89 da                	mov    %ebx,%edx
80106cd5:	ec                   	in     (%dx),%al
80106cd6:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106cdb:	ec                   	in     (%dx),%al
...
80106cdc:	83 ec 08             	sub    $0x8,%esp
80106cdf:	bb 18 8f 10 80       	mov    $0x80108f18,%ebx
80106ce4:	6a 00                	push   $0x0
80106ce6:	6a 04                	push   $0x4
80106ce8:	e8 53 b7 ff ff       	call   80102440 <ioapicenable>
80106ced:	83 c4 10             	add    $0x10,%esp
80106cf0:	b8 78 00 00 00       	mov    $0x78,%eax
80106cf5:	eb 13                	jmp    80106d0a <uartinit+0x9a>
80106cf7:	89 f6                	mov    %esi,%esi
80106cf9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106d00:	83 c3 01             	add    $0x1,%ebx
80106d03:	0f be 03             	movsbl (%ebx),%eax
80106d06:	84 c0                	test   %al,%al
80106d08:	74 19                	je     80106d23 <uartinit+0xb3>
void
uartputc(int c)
{
  int i;
  ...
  if(!uart)
80106d0a:	8b 15 c0 c5 10 80    	mov    0x8010c5c0,%edx
80106d10:	85 d2                	test   %edx,%edx
80106d12:	74 ec                	je     80106d00 <uartinit+0x90>
  inb(COM1+2);
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106d14:	83 c3 01             	add    $0x1,%ebx
80106d17:	e8 04 ff ff ff       	call   80106c20 <uartputc.part.0>
80106d1c:	0f be 03             	movsbl (%ebx),%eax
80106d1f:	84 c0                	test   %al,%al
80106d21:	75 e7                	jne    80106d0a <uartinit+0x9a>
    uartputc(*p);
}
...
uartputc(int c)
{
  ...
  if(!uart)
80106d30:	8b 15 c0 c5 10 80    	mov    0x8010c5c0,%edx
    uartputc(*p);
}
...
80106d3b:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  if(!uart)
80106d3e:	74 10                	je     80106d50 <uartputc+0x20>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
    microdelay(10);
  outb(COM1+0, c);
...
80106d40:	5d                   	pop    %ebp
80106d41:	e9 da fe ff ff       	jmp    80106c20 <uartputc.part.0>
...
80106d66:	68 f0 6b 10 80       	push   $0x80106bf0
80106d6b:	e8 00 9b ff ff       	call   80100870 <consoleintr>
}
...
80106d77:	6a 00                	push   $0x0
  jmp alltraps
80106d79:	e9 31 fb ff ff       	jmp    801068af <alltraps>
...
80106d80:	6a 01                	push   $0x1
  jmp alltraps
80106d82:	e9 28 fb ff ff       	jmp    801068af <alltraps>
...
80106d87:	6a 00                	push   $0x0
  pushl $2
80106d89:	6a 02                	push   $0x2
  jmp alltraps
80106d8b:	e9 1f fb ff ff       	jmp    801068af <alltraps>
...
80106d90:	6a 00                	push   $0x0
  pushl $3
80106d92:	6a 03                	push   $0x3
  jmp alltraps
80106d94:	e9 16 fb ff ff       	jmp    801068af <alltraps>
...
80106d99:	6a 00                	push   $0x0
  pushl $4
80106d9b:	6a 04                	push   $0x4
  jmp alltraps
80106d9d:	e9 0d fb ff ff       	jmp    801068af <alltraps>
...
80106da2:	6a 00                	push   $0x0
  pushl $5
80106da4:	6a 05                	push   $0x5
  jmp alltraps
80106da6:	e9 04 fb ff ff       	jmp    801068af <alltraps>
...
80106dad:	6a 06                	push   $0x6
  jmp alltraps
80106daf:	e9 fb fa ff ff       	jmp    801068af <alltraps>
...
80106db4:	6a 00                	push   $0x0
  pushl $7
80106db6:	6a 07                	push   $0x7
  jmp alltraps
80106db8:	e9 f2 fa ff ff       	jmp    801068af <alltraps>

80106dbd <vector8>:
.globl vector8
vector8:
  pushl $8
80106dbd:	6a 08                	push   $0x8
  jmp alltraps
80106dbf:	e9 eb fa ff ff       	jmp    801068af <alltraps>
...
80106dc4:	6a 00                	push   $0x0
  pushl $9
80106dc6:	6a 09                	push   $0x9
  jmp alltraps
80106dc8:	e9 e2 fa ff ff       	jmp    801068af <alltraps>

80106dcd <vector10>:
.globl vector10
vector10:
  pushl $10
80106dcd:	6a 0a                	push   $0xa
  jmp alltraps
80106dcf:	e9 db fa ff ff       	jmp    801068af <alltraps>

80106dd4 <vector11>:
.globl vector11
vector11:
  pushl $11
80106dd4:	6a 0b                	push   $0xb
  jmp alltraps
80106dd6:	e9 d4 fa ff ff       	jmp    801068af <alltraps>

80106ddb <vector12>:
.globl vector12
vector12:
  pushl $12
80106ddb:	6a 0c                	push   $0xc
  jmp alltraps
80106ddd:	e9 cd fa ff ff       	jmp    801068af <alltraps>

80106de2 <vector13>:
.globl vector13
vector13:
  pushl $13
80106de2:	6a 0d                	push   $0xd
  jmp alltraps
80106de4:	e9 c6 fa ff ff       	jmp    801068af <alltraps>

80106de9 <vector14>:
.globl vector14
vector14:
  pushl $14
80106de9:	6a 0e                	push   $0xe
  jmp alltraps
80106deb:	e9 bf fa ff ff       	jmp    801068af <alltraps>
...
80106df0:	6a 00                	push   $0x0
  pushl $15
80106df2:	6a 0f                	push   $0xf
  jmp alltraps
80106df4:	e9 b6 fa ff ff       	jmp    801068af <alltraps>
...
80106df9:	6a 00                	push   $0x0
  pushl $16
80106dfb:	6a 10                	push   $0x10
  jmp alltraps
80106dfd:	e9 ad fa ff ff       	jmp    801068af <alltraps>

80106e02 <vector17>:
.globl vector17
vector17:
  pushl $17
80106e02:	6a 11                	push   $0x11
  jmp alltraps
80106e04:	e9 a6 fa ff ff       	jmp    801068af <alltraps>
...
80106e09:	6a 00                	push   $0x0
  pushl $18
80106e0b:	6a 12                	push   $0x12
  jmp alltraps
80106e0d:	e9 9d fa ff ff       	jmp    801068af <alltraps>
...
80106e12:	6a 00                	push   $0x0
  pushl $19
80106e14:	6a 13                	push   $0x13
  jmp alltraps
80106e16:	e9 94 fa ff ff       	jmp    801068af <alltraps>
...
80106e1b:	6a 00                	push   $0x0
  pushl $20
80106e1d:	6a 14                	push   $0x14
  jmp alltraps
80106e1f:	e9 8b fa ff ff       	jmp    801068af <alltraps>
...
80106e24:	6a 00                	push   $0x0
  pushl $21
80106e26:	6a 15                	push   $0x15
  jmp alltraps
80106e28:	e9 82 fa ff ff       	jmp    801068af <alltraps>
...
80106e2d:	6a 00                	push   $0x0
  pushl $22
80106e2f:	6a 16                	push   $0x16
  jmp alltraps
80106e31:	e9 79 fa ff ff       	jmp    801068af <alltraps>
...
80106e36:	6a 00                	push   $0x0
  pushl $23
80106e38:	6a 17                	push   $0x17
  jmp alltraps
80106e3a:	e9 70 fa ff ff       	jmp    801068af <alltraps>
...
80106e3f:	6a 00                	push   $0x0
  pushl $24
80106e41:	6a 18                	push   $0x18
  jmp alltraps
80106e43:	e9 67 fa ff ff       	jmp    801068af <alltraps>
...
80106e48:	6a 00                	push   $0x0
  pushl $25
80106e4a:	6a 19                	push   $0x19
  jmp alltraps
80106e4c:	e9 5e fa ff ff       	jmp    801068af <alltraps>
...
80106e51:	6a 00                	push   $0x0
  pushl $26
80106e53:	6a 1a                	push   $0x1a
  jmp alltraps
80106e55:	e9 55 fa ff ff       	jmp    801068af <alltraps>
...
80106e5a:	6a 00                	push   $0x0
  pushl $27
80106e5c:	6a 1b                	push   $0x1b
  jmp alltraps
80106e5e:	e9 4c fa ff ff       	jmp    801068af <alltraps>
...
80106e63:	6a 00                	push   $0x0
  pushl $28
80106e65:	6a 1c                	push   $0x1c
  jmp alltraps
80106e67:	e9 43 fa ff ff       	jmp    801068af <alltraps>
...
80106e6c:	6a 00                	push   $0x0
  pushl $29
80106e6e:	6a 1d                	push   $0x1d
  jmp alltraps
80106e70:	e9 3a fa ff ff       	jmp    801068af <alltraps>
...
80106e75:	6a 00                	push   $0x0
  pushl $30
80106e77:	6a 1e                	push   $0x1e
  jmp alltraps
80106e79:	e9 31 fa ff ff       	jmp    801068af <alltraps>
...
80106e7e:	6a 00                	push   $0x0
  pushl $31
80106e80:	6a 1f                	push   $0x1f
  jmp alltraps
80106e82:	e9 28 fa ff ff       	jmp    801068af <alltraps>
...
80106e87:	6a 00                	push   $0x0
  pushl $32
80106e89:	6a 20                	push   $0x20
  jmp alltraps
80106e8b:	e9 1f fa ff ff       	jmp    801068af <alltraps>
...
80106e90:	6a 00                	push   $0x0
  pushl $33
80106e92:	6a 21                	push   $0x21
  jmp alltraps
80106e94:	e9 16 fa ff ff       	jmp    801068af <alltraps>
...
80106e99:	6a 00                	push   $0x0
  pushl $34
80106e9b:	6a 22                	push   $0x22
  jmp alltraps
80106e9d:	e9 0d fa ff ff       	jmp    801068af <alltraps>
...
80106ea2:	6a 00                	push   $0x0
  pushl $35
80106ea4:	6a 23                	push   $0x23
  jmp alltraps
80106ea6:	e9 04 fa ff ff       	jmp    801068af <alltraps>
...
80106eab:	6a 00                	push   $0x0
  pushl $36
80106ead:	6a 24                	push   $0x24
  jmp alltraps
80106eaf:	e9 fb f9 ff ff       	jmp    801068af <alltraps>
...
80106eb4:	6a 00                	push   $0x0
  pushl $37
80106eb6:	6a 25                	push   $0x25
  jmp alltraps
80106eb8:	e9 f2 f9 ff ff       	jmp    801068af <alltraps>
...
80106ebd:	6a 00                	push   $0x0
  pushl $38
80106ebf:	6a 26                	push   $0x26
  jmp alltraps
80106ec1:	e9 e9 f9 ff ff       	jmp    801068af <alltraps>
...
80106ec6:	6a 00                	push   $0x0
  pushl $39
80106ec8:	6a 27                	push   $0x27
  jmp alltraps
80106eca:	e9 e0 f9 ff ff       	jmp    801068af <alltraps>
...
80106ecf:	6a 00                	push   $0x0
  pushl $40
80106ed1:	6a 28                	push   $0x28
  jmp alltraps
80106ed3:	e9 d7 f9 ff ff       	jmp    801068af <alltraps>
...
80106ed8:	6a 00                	push   $0x0
  pushl $41
80106eda:	6a 29                	push   $0x29
  jmp alltraps
80106edc:	e9 ce f9 ff ff       	jmp    801068af <alltraps>
...
80106ee1:	6a 00                	push   $0x0
  pushl $42
80106ee3:	6a 2a                	push   $0x2a
  jmp alltraps
80106ee5:	e9 c5 f9 ff ff       	jmp    801068af <alltraps>
...
80106eea:	6a 00                	push   $0x0
  pushl $43
80106eec:	6a 2b                	push   $0x2b
  jmp alltraps
80106eee:	e9 bc f9 ff ff       	jmp    801068af <alltraps>
...
80106ef3:	6a 00                	push   $0x0
  pushl $44
80106ef5:	6a 2c                	push   $0x2c
  jmp alltraps
80106ef7:	e9 b3 f9 ff ff       	jmp    801068af <alltraps>
...
80106efc:	6a 00                	push   $0x0
  pushl $45
80106efe:	6a 2d                	push   $0x2d
  jmp alltraps
80106f00:	e9 aa f9 ff ff       	jmp    801068af <alltraps>
...
80106f05:	6a 00                	push   $0x0
  pushl $46
80106f07:	6a 2e                	push   $0x2e
  jmp alltraps
80106f09:	e9 a1 f9 ff ff       	jmp    801068af <alltraps>
...
80106f0e:	6a 00                	push   $0x0
  pushl $47
80106f10:	6a 2f                	push   $0x2f
  jmp alltraps
80106f12:	e9 98 f9 ff ff       	jmp    801068af <alltraps>
...
80106f17:	6a 00                	push   $0x0
  pushl $48
80106f19:	6a 30                	push   $0x30
  jmp alltraps
80106f1b:	e9 8f f9 ff ff       	jmp    801068af <alltraps>
...
80106f20:	6a 00                	push   $0x0
  pushl $49
80106f22:	6a 31                	push   $0x31
  jmp alltraps
80106f24:	e9 86 f9 ff ff       	jmp    801068af <alltraps>
...
80106f29:	6a 00                	push   $0x0
  pushl $50
80106f2b:	6a 32                	push   $0x32
  jmp alltraps
80106f2d:	e9 7d f9 ff ff       	jmp    801068af <alltraps>
...
80106f32:	6a 00                	push   $0x0
  pushl $51
80106f34:	6a 33                	push   $0x33
  jmp alltraps
80106f36:	e9 74 f9 ff ff       	jmp    801068af <alltraps>
...
80106f3b:	6a 00                	push   $0x0
  pushl $52
80106f3d:	6a 34                	push   $0x34
  jmp alltraps
80106f3f:	e9 6b f9 ff ff       	jmp    801068af <alltraps>
...
80106f44:	6a 00                	push   $0x0
  pushl $53
80106f46:	6a 35                	push   $0x35
  jmp alltraps
80106f48:	e9 62 f9 ff ff       	jmp    801068af <alltraps>
...
80106f4d:	6a 00                	push   $0x0
  pushl $54
80106f4f:	6a 36                	push   $0x36
  jmp alltraps
80106f51:	e9 59 f9 ff ff       	jmp    801068af <alltraps>
...
80106f56:	6a 00                	push   $0x0
  pushl $55
80106f58:	6a 37                	push   $0x37
  jmp alltraps
80106f5a:	e9 50 f9 ff ff       	jmp    801068af <alltraps>
...
80106f5f:	6a 00                	push   $0x0
  pushl $56
80106f61:	6a 38                	push   $0x38
  jmp alltraps
80106f63:	e9 47 f9 ff ff       	jmp    801068af <alltraps>
...
80106f68:	6a 00                	push   $0x0
  pushl $57
80106f6a:	6a 39                	push   $0x39
  jmp alltraps
80106f6c:	e9 3e f9 ff ff       	jmp    801068af <alltraps>
...
80106f71:	6a 00                	push   $0x0
  pushl $58
80106f73:	6a 3a                	push   $0x3a
  jmp alltraps
80106f75:	e9 35 f9 ff ff       	jmp    801068af <alltraps>
...
80106f7a:	6a 00                	push   $0x0
  pushl $59
80106f7c:	6a 3b                	push   $0x3b
  jmp alltraps
80106f7e:	e9 2c f9 ff ff       	jmp    801068af <alltraps>
...
80106f83:	6a 00                	push   $0x0
  pushl $60
80106f85:	6a 3c                	push   $0x3c
  jmp alltraps
80106f87:	e9 23 f9 ff ff       	jmp    801068af <alltraps>
...
80106f8c:	6a 00                	push   $0x0
  pushl $61
80106f8e:	6a 3d                	push   $0x3d
  jmp alltraps
80106f90:	e9 1a f9 ff ff       	jmp    801068af <alltraps>
...
80106f95:	6a 00                	push   $0x0
  pushl $62
80106f97:	6a 3e                	push   $0x3e
  jmp alltraps
80106f99:	e9 11 f9 ff ff       	jmp    801068af <alltraps>
...
80106f9e:	6a 00                	push   $0x0
  pushl $63
80106fa0:	6a 3f                	push   $0x3f
  jmp alltraps
80106fa2:	e9 08 f9 ff ff       	jmp    801068af <alltraps>
...
80106fa7:	6a 00                	push   $0x0
  pushl $64
80106fa9:	6a 40                	push   $0x40
  jmp alltraps
80106fab:	e9 ff f8 ff ff       	jmp    801068af <alltraps>
...
80106fb0:	6a 00                	push   $0x0
  pushl $65
80106fb2:	6a 41                	push   $0x41
  jmp alltraps
80106fb4:	e9 f6 f8 ff ff       	jmp    801068af <alltraps>
...
80106fb9:	6a 00                	push   $0x0
  pushl $66
80106fbb:	6a 42                	push   $0x42
  jmp alltraps
80106fbd:	e9 ed f8 ff ff       	jmp    801068af <alltraps>
...
80106fc2:	6a 00                	push   $0x0
  pushl $67
80106fc4:	6a 43                	push   $0x43
  jmp alltraps
80106fc6:	e9 e4 f8 ff ff       	jmp    801068af <alltraps>
...
80106fcb:	6a 00                	push   $0x0
  pushl $68
80106fcd:	6a 44                	push   $0x44
  jmp alltraps
80106fcf:	e9 db f8 ff ff       	jmp    801068af <alltraps>
...
80106fd4:	6a 00                	push   $0x0
  pushl $69
80106fd6:	6a 45                	push   $0x45
  jmp alltraps
80106fd8:	e9 d2 f8 ff ff       	jmp    801068af <alltraps>
...
80106fdd:	6a 00                	push   $0x0
  pushl $70
80106fdf:	6a 46                	push   $0x46
  jmp alltraps
80106fe1:	e9 c9 f8 ff ff       	jmp    801068af <alltraps>
...
80106fe6:	6a 00                	push   $0x0
  pushl $71
80106fe8:	6a 47                	push   $0x47
  jmp alltraps
80106fea:	e9 c0 f8 ff ff       	jmp    801068af <alltraps>
...
80106fef:	6a 00                	push   $0x0
  pushl $72
80106ff1:	6a 48                	push   $0x48
  jmp alltraps
80106ff3:	e9 b7 f8 ff ff       	jmp    801068af <alltraps>
...
80106ff8:	6a 00                	push   $0x0
  pushl $73
80106ffa:	6a 49                	push   $0x49
  jmp alltraps
80106ffc:	e9 ae f8 ff ff       	jmp    801068af <alltraps>
...
80107001:	6a 00                	push   $0x0
  pushl $74
80107003:	6a 4a                	push   $0x4a
  jmp alltraps
80107005:	e9 a5 f8 ff ff       	jmp    801068af <alltraps>
...
8010700a:	6a 00                	push   $0x0
  pushl $75
8010700c:	6a 4b                	push   $0x4b
  jmp alltraps
8010700e:	e9 9c f8 ff ff       	jmp    801068af <alltraps>
...
80107013:	6a 00                	push   $0x0
  pushl $76
80107015:	6a 4c                	push   $0x4c
  jmp alltraps
80107017:	e9 93 f8 ff ff       	jmp    801068af <alltraps>
...
8010701c:	6a 00                	push   $0x0
  pushl $77
8010701e:	6a 4d                	push   $0x4d
  jmp alltraps
80107020:	e9 8a f8 ff ff       	jmp    801068af <alltraps>
...
80107025:	6a 00                	push   $0x0
  pushl $78
80107027:	6a 4e                	push   $0x4e
  jmp alltraps
80107029:	e9 81 f8 ff ff       	jmp    801068af <alltraps>
...
8010702e:	6a 00                	push   $0x0
  pushl $79
80107030:	6a 4f                	push   $0x4f
  jmp alltraps
80107032:	e9 78 f8 ff ff       	jmp    801068af <alltraps>
...
80107037:	6a 00                	push   $0x0
  pushl $80
80107039:	6a 50                	push   $0x50
  jmp alltraps
8010703b:	e9 6f f8 ff ff       	jmp    801068af <alltraps>
...
80107040:	6a 00                	push   $0x0
  pushl $81
80107042:	6a 51                	push   $0x51
  jmp alltraps
80107044:	e9 66 f8 ff ff       	jmp    801068af <alltraps>
...
80107049:	6a 00                	push   $0x0
  pushl $82
8010704b:	6a 52                	push   $0x52
  jmp alltraps
8010704d:	e9 5d f8 ff ff       	jmp    801068af <alltraps>
...
80107052:	6a 00                	push   $0x0
  pushl $83
80107054:	6a 53                	push   $0x53
  jmp alltraps
80107056:	e9 54 f8 ff ff       	jmp    801068af <alltraps>
...
8010705b:	6a 00                	push   $0x0
  pushl $84
8010705d:	6a 54                	push   $0x54
  jmp alltraps
8010705f:	e9 4b f8 ff ff       	jmp    801068af <alltraps>
...
80107064:	6a 00                	push   $0x0
  pushl $85
80107066:	6a 55                	push   $0x55
  jmp alltraps
80107068:	e9 42 f8 ff ff       	jmp    801068af <alltraps>
...
8010706d:	6a 00                	push   $0x0
  pushl $86
8010706f:	6a 56                	push   $0x56
  jmp alltraps
80107071:	e9 39 f8 ff ff       	jmp    801068af <alltraps>
...
80107076:	6a 00                	push   $0x0
  pushl $87
80107078:	6a 57                	push   $0x57
  jmp alltraps
8010707a:	e9 30 f8 ff ff       	jmp    801068af <alltraps>
...
8010707f:	6a 00                	push   $0x0
  pushl $88
80107081:	6a 58                	push   $0x58
  jmp alltraps
80107083:	e9 27 f8 ff ff       	jmp    801068af <alltraps>
...
80107088:	6a 00                	push   $0x0
  pushl $89
8010708a:	6a 59                	push   $0x59
  jmp alltraps
8010708c:	e9 1e f8 ff ff       	jmp    801068af <alltraps>
...
80107091:	6a 00                	push   $0x0
  pushl $90
80107093:	6a 5a                	push   $0x5a
  jmp alltraps
80107095:	e9 15 f8 ff ff       	jmp    801068af <alltraps>
...
8010709a:	6a 00                	push   $0x0
  pushl $91
8010709c:	6a 5b                	push   $0x5b
  jmp alltraps
8010709e:	e9 0c f8 ff ff       	jmp    801068af <alltraps>
...
801070a3:	6a 00                	push   $0x0
  pushl $92
801070a5:	6a 5c                	push   $0x5c
  jmp alltraps
801070a7:	e9 03 f8 ff ff       	jmp    801068af <alltraps>
...
801070ac:	6a 00                	push   $0x0
  pushl $93
801070ae:	6a 5d                	push   $0x5d
  jmp alltraps
801070b0:	e9 fa f7 ff ff       	jmp    801068af <alltraps>
...
801070b5:	6a 00                	push   $0x0
  pushl $94
801070b7:	6a 5e                	push   $0x5e
  jmp alltraps
801070b9:	e9 f1 f7 ff ff       	jmp    801068af <alltraps>
...
801070be:	6a 00                	push   $0x0
  pushl $95
801070c0:	6a 5f                	push   $0x5f
  jmp alltraps
801070c2:	e9 e8 f7 ff ff       	jmp    801068af <alltraps>
...
801070c7:	6a 00                	push   $0x0
  pushl $96
801070c9:	6a 60                	push   $0x60
  jmp alltraps
801070cb:	e9 df f7 ff ff       	jmp    801068af <alltraps>
...
801070d0:	6a 00                	push   $0x0
  pushl $97
801070d2:	6a 61                	push   $0x61
  jmp alltraps
801070d4:	e9 d6 f7 ff ff       	jmp    801068af <alltraps>
...
801070d9:	6a 00                	push   $0x0
  pushl $98
801070db:	6a 62                	push   $0x62
  jmp alltraps
801070dd:	e9 cd f7 ff ff       	jmp    801068af <alltraps>
...
801070e2:	6a 00                	push   $0x0
  pushl $99
801070e4:	6a 63                	push   $0x63
  jmp alltraps
801070e6:	e9 c4 f7 ff ff       	jmp    801068af <alltraps>
...
801070eb:	6a 00                	push   $0x0
  pushl $100
801070ed:	6a 64                	push   $0x64
  jmp alltraps
801070ef:	e9 bb f7 ff ff       	jmp    801068af <alltraps>
...
801070f4:	6a 00                	push   $0x0
  pushl $101
801070f6:	6a 65                	push   $0x65
  jmp alltraps
801070f8:	e9 b2 f7 ff ff       	jmp    801068af <alltraps>
...
801070fd:	6a 00                	push   $0x0
  pushl $102
801070ff:	6a 66                	push   $0x66
  jmp alltraps
80107101:	e9 a9 f7 ff ff       	jmp    801068af <alltraps>
...
80107106:	6a 00                	push   $0x0
  pushl $103
80107108:	6a 67                	push   $0x67
  jmp alltraps
8010710a:	e9 a0 f7 ff ff       	jmp    801068af <alltraps>
...
8010710f:	6a 00                	push   $0x0
  pushl $104
80107111:	6a 68                	push   $0x68
  jmp alltraps
80107113:	e9 97 f7 ff ff       	jmp    801068af <alltraps>
...
80107118:	6a 00                	push   $0x0
  pushl $105
8010711a:	6a 69                	push   $0x69
  jmp alltraps
8010711c:	e9 8e f7 ff ff       	jmp    801068af <alltraps>
...
80107121:	6a 00                	push   $0x0
  pushl $106
80107123:	6a 6a                	push   $0x6a
  jmp alltraps
80107125:	e9 85 f7 ff ff       	jmp    801068af <alltraps>
...
8010712a:	6a 00                	push   $0x0
  pushl $107
8010712c:	6a 6b                	push   $0x6b
  jmp alltraps
8010712e:	e9 7c f7 ff ff       	jmp    801068af <alltraps>
...
80107133:	6a 00                	push   $0x0
  pushl $108
80107135:	6a 6c                	push   $0x6c
  jmp alltraps
80107137:	e9 73 f7 ff ff       	jmp    801068af <alltraps>
...
8010713c:	6a 00                	push   $0x0
  pushl $109
8010713e:	6a 6d                	push   $0x6d
  jmp alltraps
80107140:	e9 6a f7 ff ff       	jmp    801068af <alltraps>
...
80107145:	6a 00                	push   $0x0
  pushl $110
80107147:	6a 6e                	push   $0x6e
  jmp alltraps
80107149:	e9 61 f7 ff ff       	jmp    801068af <alltraps>
...
8010714e:	6a 00                	push   $0x0
  pushl $111
80107150:	6a 6f                	push   $0x6f
  jmp alltraps
80107152:	e9 58 f7 ff ff       	jmp    801068af <alltraps>
...
80107157:	6a 00                	push   $0x0
  pushl $112
80107159:	6a 70                	push   $0x70
  jmp alltraps
8010715b:	e9 4f f7 ff ff       	jmp    801068af <alltraps>
...
80107160:	6a 00                	push   $0x0
  pushl $113
80107162:	6a 71                	push   $0x71
  jmp alltraps
80107164:	e9 46 f7 ff ff       	jmp    801068af <alltraps>
...
80107169:	6a 00                	push   $0x0
  pushl $114
8010716b:	6a 72                	push   $0x72
  jmp alltraps
8010716d:	e9 3d f7 ff ff       	jmp    801068af <alltraps>
...
80107172:	6a 00                	push   $0x0
  pushl $115
80107174:	6a 73                	push   $0x73
  jmp alltraps
80107176:	e9 34 f7 ff ff       	jmp    801068af <alltraps>
...
8010717b:	6a 00                	push   $0x0
  pushl $116
8010717d:	6a 74                	push   $0x74
  jmp alltraps
8010717f:	e9 2b f7 ff ff       	jmp    801068af <alltraps>
...
80107184:	6a 00                	push   $0x0
  pushl $117
80107186:	6a 75                	push   $0x75
  jmp alltraps
80107188:	e9 22 f7 ff ff       	jmp    801068af <alltraps>
...
8010718d:	6a 00                	push   $0x0
  pushl $118
8010718f:	6a 76                	push   $0x76
  jmp alltraps
80107191:	e9 19 f7 ff ff       	jmp    801068af <alltraps>
...
80107196:	6a 00                	push   $0x0
  pushl $119
80107198:	6a 77                	push   $0x77
  jmp alltraps
8010719a:	e9 10 f7 ff ff       	jmp    801068af <alltraps>
...
8010719f:	6a 00                	push   $0x0
  pushl $120
801071a1:	6a 78                	push   $0x78
  jmp alltraps
801071a3:	e9 07 f7 ff ff       	jmp    801068af <alltraps>
...
801071a8:	6a 00                	push   $0x0
  pushl $121
801071aa:	6a 79                	push   $0x79
  jmp alltraps
801071ac:	e9 fe f6 ff ff       	jmp    801068af <alltraps>
...
801071b1:	6a 00                	push   $0x0
  pushl $122
801071b3:	6a 7a                	push   $0x7a
  jmp alltraps
801071b5:	e9 f5 f6 ff ff       	jmp    801068af <alltraps>
...
801071ba:	6a 00                	push   $0x0
  pushl $123
801071bc:	6a 7b                	push   $0x7b
  jmp alltraps
801071be:	e9 ec f6 ff ff       	jmp    801068af <alltraps>
...
801071c3:	6a 00                	push   $0x0
  pushl $124
801071c5:	6a 7c                	push   $0x7c
  jmp alltraps
801071c7:	e9 e3 f6 ff ff       	jmp    801068af <alltraps>
...
801071cc:	6a 00                	push   $0x0
  pushl $125
801071ce:	6a 7d                	push   $0x7d
  jmp alltraps
801071d0:	e9 da f6 ff ff       	jmp    801068af <alltraps>
...
801071d5:	6a 00                	push   $0x0
  pushl $126
801071d7:	6a 7e                	push   $0x7e
  jmp alltraps
801071d9:	e9 d1 f6 ff ff       	jmp    801068af <alltraps>
...
801071de:	6a 00                	push   $0x0
  pushl $127
801071e0:	6a 7f                	push   $0x7f
  jmp alltraps
801071e2:	e9 c8 f6 ff ff       	jmp    801068af <alltraps>
...
801071e9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801071ee:	e9 bc f6 ff ff       	jmp    801068af <alltraps>
...
801071f3:	6a 00                	push   $0x0
  pushl $129
801071f5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801071fa:	e9 b0 f6 ff ff       	jmp    801068af <alltraps>
...
801071ff:	6a 00                	push   $0x0
  pushl $130
80107201:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107206:	e9 a4 f6 ff ff       	jmp    801068af <alltraps>
...
8010720b:	6a 00                	push   $0x0
  pushl $131
8010720d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107212:	e9 98 f6 ff ff       	jmp    801068af <alltraps>
...
80107217:	6a 00                	push   $0x0
  pushl $132
80107219:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010721e:	e9 8c f6 ff ff       	jmp    801068af <alltraps>
...
80107223:	6a 00                	push   $0x0
  pushl $133
80107225:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010722a:	e9 80 f6 ff ff       	jmp    801068af <alltraps>
...
8010722f:	6a 00                	push   $0x0
  pushl $134
80107231:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107236:	e9 74 f6 ff ff       	jmp    801068af <alltraps>
...
8010723b:	6a 00                	push   $0x0
  pushl $135
8010723d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107242:	e9 68 f6 ff ff       	jmp    801068af <alltraps>
...
80107247:	6a 00                	push   $0x0
  pushl $136
80107249:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010724e:	e9 5c f6 ff ff       	jmp    801068af <alltraps>
...
80107253:	6a 00                	push   $0x0
  pushl $137
80107255:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010725a:	e9 50 f6 ff ff       	jmp    801068af <alltraps>
...
8010725f:	6a 00                	push   $0x0
  pushl $138
80107261:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107266:	e9 44 f6 ff ff       	jmp    801068af <alltraps>
...
8010726b:	6a 00                	push   $0x0
  pushl $139
8010726d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107272:	e9 38 f6 ff ff       	jmp    801068af <alltraps>
...
80107277:	6a 00                	push   $0x0
  pushl $140
80107279:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010727e:	e9 2c f6 ff ff       	jmp    801068af <alltraps>
...
80107283:	6a 00                	push   $0x0
  pushl $141
80107285:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010728a:	e9 20 f6 ff ff       	jmp    801068af <alltraps>
...
8010728f:	6a 00                	push   $0x0
  pushl $142
80107291:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107296:	e9 14 f6 ff ff       	jmp    801068af <alltraps>
...
8010729b:	6a 00                	push   $0x0
  pushl $143
8010729d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801072a2:	e9 08 f6 ff ff       	jmp    801068af <alltraps>
...
801072a7:	6a 00                	push   $0x0
  pushl $144
801072a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801072ae:	e9 fc f5 ff ff       	jmp    801068af <alltraps>
...
801072b3:	6a 00                	push   $0x0
  pushl $145
801072b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801072ba:	e9 f0 f5 ff ff       	jmp    801068af <alltraps>
...
801072bf:	6a 00                	push   $0x0
  pushl $146
801072c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801072c6:	e9 e4 f5 ff ff       	jmp    801068af <alltraps>
...
801072cb:	6a 00                	push   $0x0
  pushl $147
801072cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801072d2:	e9 d8 f5 ff ff       	jmp    801068af <alltraps>
...
801072d7:	6a 00                	push   $0x0
  pushl $148
801072d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801072de:	e9 cc f5 ff ff       	jmp    801068af <alltraps>
...
801072e3:	6a 00                	push   $0x0
  pushl $149
801072e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801072ea:	e9 c0 f5 ff ff       	jmp    801068af <alltraps>
...
801072ef:	6a 00                	push   $0x0
  pushl $150
801072f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801072f6:	e9 b4 f5 ff ff       	jmp    801068af <alltraps>
...
801072fb:	6a 00                	push   $0x0
  pushl $151
801072fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107302:	e9 a8 f5 ff ff       	jmp    801068af <alltraps>
...
80107307:	6a 00                	push   $0x0
  pushl $152
80107309:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010730e:	e9 9c f5 ff ff       	jmp    801068af <alltraps>
...
80107313:	6a 00                	push   $0x0
  pushl $153
80107315:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010731a:	e9 90 f5 ff ff       	jmp    801068af <alltraps>
...
8010731f:	6a 00                	push   $0x0
  pushl $154
80107321:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107326:	e9 84 f5 ff ff       	jmp    801068af <alltraps>
...
8010732b:	6a 00                	push   $0x0
  pushl $155
8010732d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107332:	e9 78 f5 ff ff       	jmp    801068af <alltraps>
...
80107337:	6a 00                	push   $0x0
  pushl $156
80107339:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010733e:	e9 6c f5 ff ff       	jmp    801068af <alltraps>
...
80107343:	6a 00                	push   $0x0
  pushl $157
80107345:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010734a:	e9 60 f5 ff ff       	jmp    801068af <alltraps>
...
8010734f:	6a 00                	push   $0x0
  pushl $158
80107351:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107356:	e9 54 f5 ff ff       	jmp    801068af <alltraps>
...
8010735b:	6a 00                	push   $0x0
  pushl $159
8010735d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107362:	e9 48 f5 ff ff       	jmp    801068af <alltraps>
...
80107367:	6a 00                	push   $0x0
  pushl $160
80107369:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010736e:	e9 3c f5 ff ff       	jmp    801068af <alltraps>
...
80107373:	6a 00                	push   $0x0
  pushl $161
80107375:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010737a:	e9 30 f5 ff ff       	jmp    801068af <alltraps>
...
8010737f:	6a 00                	push   $0x0
  pushl $162
80107381:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107386:	e9 24 f5 ff ff       	jmp    801068af <alltraps>
...
8010738b:	6a 00                	push   $0x0
  pushl $163
8010738d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107392:	e9 18 f5 ff ff       	jmp    801068af <alltraps>
...
80107397:	6a 00                	push   $0x0
  pushl $164
80107399:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010739e:	e9 0c f5 ff ff       	jmp    801068af <alltraps>
...
801073a3:	6a 00                	push   $0x0
  pushl $165
801073a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801073aa:	e9 00 f5 ff ff       	jmp    801068af <alltraps>
...
801073af:	6a 00                	push   $0x0
  pushl $166
801073b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801073b6:	e9 f4 f4 ff ff       	jmp    801068af <alltraps>
...
801073bb:	6a 00                	push   $0x0
  pushl $167
801073bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801073c2:	e9 e8 f4 ff ff       	jmp    801068af <alltraps>
...
801073c7:	6a 00                	push   $0x0
  pushl $168
801073c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801073ce:	e9 dc f4 ff ff       	jmp    801068af <alltraps>
...
801073d3:	6a 00                	push   $0x0
  pushl $169
801073d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801073da:	e9 d0 f4 ff ff       	jmp    801068af <alltraps>
...
801073df:	6a 00                	push   $0x0
  pushl $170
801073e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801073e6:	e9 c4 f4 ff ff       	jmp    801068af <alltraps>
...
801073eb:	6a 00                	push   $0x0
  pushl $171
801073ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801073f2:	e9 b8 f4 ff ff       	jmp    801068af <alltraps>
...
801073f7:	6a 00                	push   $0x0
  pushl $172
801073f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801073fe:	e9 ac f4 ff ff       	jmp    801068af <alltraps>
...
80107403:	6a 00                	push   $0x0
  pushl $173
80107405:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010740a:	e9 a0 f4 ff ff       	jmp    801068af <alltraps>
...
8010740f:	6a 00                	push   $0x0
  pushl $174
80107411:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107416:	e9 94 f4 ff ff       	jmp    801068af <alltraps>
...
8010741b:	6a 00                	push   $0x0
  pushl $175
8010741d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107422:	e9 88 f4 ff ff       	jmp    801068af <alltraps>
...
80107427:	6a 00                	push   $0x0
  pushl $176
80107429:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010742e:	e9 7c f4 ff ff       	jmp    801068af <alltraps>
...
80107433:	6a 00                	push   $0x0
  pushl $177
80107435:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010743a:	e9 70 f4 ff ff       	jmp    801068af <alltraps>
...
8010743f:	6a 00                	push   $0x0
  pushl $178
80107441:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107446:	e9 64 f4 ff ff       	jmp    801068af <alltraps>
...
8010744b:	6a 00                	push   $0x0
  pushl $179
8010744d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107452:	e9 58 f4 ff ff       	jmp    801068af <alltraps>
...
80107457:	6a 00                	push   $0x0
  pushl $180
80107459:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010745e:	e9 4c f4 ff ff       	jmp    801068af <alltraps>
...
80107463:	6a 00                	push   $0x0
  pushl $181
80107465:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010746a:	e9 40 f4 ff ff       	jmp    801068af <alltraps>
...
8010746f:	6a 00                	push   $0x0
  pushl $182
80107471:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107476:	e9 34 f4 ff ff       	jmp    801068af <alltraps>
...
8010747b:	6a 00                	push   $0x0
  pushl $183
8010747d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107482:	e9 28 f4 ff ff       	jmp    801068af <alltraps>
...
80107487:	6a 00                	push   $0x0
  pushl $184
80107489:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010748e:	e9 1c f4 ff ff       	jmp    801068af <alltraps>
...
80107493:	6a 00                	push   $0x0
  pushl $185
80107495:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010749a:	e9 10 f4 ff ff       	jmp    801068af <alltraps>
...
8010749f:	6a 00                	push   $0x0
  pushl $186
801074a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801074a6:	e9 04 f4 ff ff       	jmp    801068af <alltraps>
...
801074ab:	6a 00                	push   $0x0
  pushl $187
801074ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801074b2:	e9 f8 f3 ff ff       	jmp    801068af <alltraps>
...
801074b7:	6a 00                	push   $0x0
  pushl $188
801074b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801074be:	e9 ec f3 ff ff       	jmp    801068af <alltraps>
...
801074c3:	6a 00                	push   $0x0
  pushl $189
801074c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801074ca:	e9 e0 f3 ff ff       	jmp    801068af <alltraps>
...
801074cf:	6a 00                	push   $0x0
  pushl $190
801074d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801074d6:	e9 d4 f3 ff ff       	jmp    801068af <alltraps>
...
801074db:	6a 00                	push   $0x0
  pushl $191
801074dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801074e2:	e9 c8 f3 ff ff       	jmp    801068af <alltraps>
...
801074e7:	6a 00                	push   $0x0
  pushl $192
801074e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801074ee:	e9 bc f3 ff ff       	jmp    801068af <alltraps>
...
801074f3:	6a 00                	push   $0x0
  pushl $193
801074f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801074fa:	e9 b0 f3 ff ff       	jmp    801068af <alltraps>
...
801074ff:	6a 00                	push   $0x0
  pushl $194
80107501:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107506:	e9 a4 f3 ff ff       	jmp    801068af <alltraps>
...
8010750b:	6a 00                	push   $0x0
  pushl $195
8010750d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107512:	e9 98 f3 ff ff       	jmp    801068af <alltraps>
...
80107517:	6a 00                	push   $0x0
  pushl $196
80107519:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010751e:	e9 8c f3 ff ff       	jmp    801068af <alltraps>
...
80107523:	6a 00                	push   $0x0
  pushl $197
80107525:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010752a:	e9 80 f3 ff ff       	jmp    801068af <alltraps>
...
8010752f:	6a 00                	push   $0x0
  pushl $198
80107531:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107536:	e9 74 f3 ff ff       	jmp    801068af <alltraps>
...
8010753b:	6a 00                	push   $0x0
  pushl $199
8010753d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107542:	e9 68 f3 ff ff       	jmp    801068af <alltraps>
...
80107547:	6a 00                	push   $0x0
  pushl $200
80107549:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010754e:	e9 5c f3 ff ff       	jmp    801068af <alltraps>
...
80107553:	6a 00                	push   $0x0
  pushl $201
80107555:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010755a:	e9 50 f3 ff ff       	jmp    801068af <alltraps>
...
8010755f:	6a 00                	push   $0x0
  pushl $202
80107561:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107566:	e9 44 f3 ff ff       	jmp    801068af <alltraps>
...
8010756b:	6a 00                	push   $0x0
  pushl $203
8010756d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107572:	e9 38 f3 ff ff       	jmp    801068af <alltraps>
...
80107577:	6a 00                	push   $0x0
  pushl $204
80107579:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010757e:	e9 2c f3 ff ff       	jmp    801068af <alltraps>
...
80107583:	6a 00                	push   $0x0
  pushl $205
80107585:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010758a:	e9 20 f3 ff ff       	jmp    801068af <alltraps>
...
8010758f:	6a 00                	push   $0x0
  pushl $206
80107591:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107596:	e9 14 f3 ff ff       	jmp    801068af <alltraps>
...
8010759b:	6a 00                	push   $0x0
  pushl $207
8010759d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801075a2:	e9 08 f3 ff ff       	jmp    801068af <alltraps>
...
801075a7:	6a 00                	push   $0x0
  pushl $208
801075a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801075ae:	e9 fc f2 ff ff       	jmp    801068af <alltraps>
...
801075b3:	6a 00                	push   $0x0
  pushl $209
801075b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801075ba:	e9 f0 f2 ff ff       	jmp    801068af <alltraps>
...
801075bf:	6a 00                	push   $0x0
  pushl $210
801075c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801075c6:	e9 e4 f2 ff ff       	jmp    801068af <alltraps>
...
801075cb:	6a 00                	push   $0x0
  pushl $211
801075cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801075d2:	e9 d8 f2 ff ff       	jmp    801068af <alltraps>
...
801075d7:	6a 00                	push   $0x0
  pushl $212
801075d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801075de:	e9 cc f2 ff ff       	jmp    801068af <alltraps>
...
801075e3:	6a 00                	push   $0x0
  pushl $213
801075e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801075ea:	e9 c0 f2 ff ff       	jmp    801068af <alltraps>
...
801075ef:	6a 00                	push   $0x0
  pushl $214
801075f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801075f6:	e9 b4 f2 ff ff       	jmp    801068af <alltraps>
...
801075fb:	6a 00                	push   $0x0
  pushl $215
801075fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107602:	e9 a8 f2 ff ff       	jmp    801068af <alltraps>
...
80107607:	6a 00                	push   $0x0
  pushl $216
80107609:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010760e:	e9 9c f2 ff ff       	jmp    801068af <alltraps>
...
80107613:	6a 00                	push   $0x0
  pushl $217
80107615:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010761a:	e9 90 f2 ff ff       	jmp    801068af <alltraps>
...
8010761f:	6a 00                	push   $0x0
  pushl $218
80107621:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107626:	e9 84 f2 ff ff       	jmp    801068af <alltraps>
...
8010762b:	6a 00                	push   $0x0
  pushl $219
8010762d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107632:	e9 78 f2 ff ff       	jmp    801068af <alltraps>
...
80107637:	6a 00                	push   $0x0
  pushl $220
80107639:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010763e:	e9 6c f2 ff ff       	jmp    801068af <alltraps>
...
80107643:	6a 00                	push   $0x0
  pushl $221
80107645:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010764a:	e9 60 f2 ff ff       	jmp    801068af <alltraps>
...
8010764f:	6a 00                	push   $0x0
  pushl $222
80107651:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107656:	e9 54 f2 ff ff       	jmp    801068af <alltraps>
...
8010765b:	6a 00                	push   $0x0
  pushl $223
8010765d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107662:	e9 48 f2 ff ff       	jmp    801068af <alltraps>
...
80107667:	6a 00                	push   $0x0
  pushl $224
80107669:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010766e:	e9 3c f2 ff ff       	jmp    801068af <alltraps>
...
80107673:	6a 00                	push   $0x0
  pushl $225
80107675:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010767a:	e9 30 f2 ff ff       	jmp    801068af <alltraps>
...
8010767f:	6a 00                	push   $0x0
  pushl $226
80107681:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107686:	e9 24 f2 ff ff       	jmp    801068af <alltraps>
...
8010768b:	6a 00                	push   $0x0
  pushl $227
8010768d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107692:	e9 18 f2 ff ff       	jmp    801068af <alltraps>
...
80107697:	6a 00                	push   $0x0
  pushl $228
80107699:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010769e:	e9 0c f2 ff ff       	jmp    801068af <alltraps>
...
801076a3:	6a 00                	push   $0x0
  pushl $229
801076a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801076aa:	e9 00 f2 ff ff       	jmp    801068af <alltraps>
...
801076af:	6a 00                	push   $0x0
  pushl $230
801076b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801076b6:	e9 f4 f1 ff ff       	jmp    801068af <alltraps>
...
801076bb:	6a 00                	push   $0x0
  pushl $231
801076bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801076c2:	e9 e8 f1 ff ff       	jmp    801068af <alltraps>
...
801076c7:	6a 00                	push   $0x0
  pushl $232
801076c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801076ce:	e9 dc f1 ff ff       	jmp    801068af <alltraps>
...
801076d3:	6a 00                	push   $0x0
  pushl $233
801076d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801076da:	e9 d0 f1 ff ff       	jmp    801068af <alltraps>
...
801076df:	6a 00                	push   $0x0
  pushl $234
801076e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801076e6:	e9 c4 f1 ff ff       	jmp    801068af <alltraps>
...
801076eb:	6a 00                	push   $0x0
  pushl $235
801076ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801076f2:	e9 b8 f1 ff ff       	jmp    801068af <alltraps>
...
801076f7:	6a 00                	push   $0x0
  pushl $236
801076f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801076fe:	e9 ac f1 ff ff       	jmp    801068af <alltraps>
...
80107703:	6a 00                	push   $0x0
  pushl $237
80107705:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010770a:	e9 a0 f1 ff ff       	jmp    801068af <alltraps>
...
8010770f:	6a 00                	push   $0x0
  pushl $238
80107711:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107716:	e9 94 f1 ff ff       	jmp    801068af <alltraps>
...
8010771b:	6a 00                	push   $0x0
  pushl $239
8010771d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107722:	e9 88 f1 ff ff       	jmp    801068af <alltraps>
...
80107727:	6a 00                	push   $0x0
  pushl $240
80107729:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010772e:	e9 7c f1 ff ff       	jmp    801068af <alltraps>
...
80107733:	6a 00                	push   $0x0
  pushl $241
80107735:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010773a:	e9 70 f1 ff ff       	jmp    801068af <alltraps>
...
8010773f:	6a 00                	push   $0x0
  pushl $242
80107741:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107746:	e9 64 f1 ff ff       	jmp    801068af <alltraps>
...
8010774b:	6a 00                	push   $0x0
  pushl $243
8010774d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107752:	e9 58 f1 ff ff       	jmp    801068af <alltraps>
...
80107757:	6a 00                	push   $0x0
  pushl $244
80107759:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010775e:	e9 4c f1 ff ff       	jmp    801068af <alltraps>
...
80107763:	6a 00                	push   $0x0
  pushl $245
80107765:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010776a:	e9 40 f1 ff ff       	jmp    801068af <alltraps>
...
8010776f:	6a 00                	push   $0x0
  pushl $246
80107771:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107776:	e9 34 f1 ff ff       	jmp    801068af <alltraps>
...
8010777b:	6a 00                	push   $0x0
  pushl $247
8010777d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107782:	e9 28 f1 ff ff       	jmp    801068af <alltraps>
...
80107787:	6a 00                	push   $0x0
  pushl $248
80107789:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010778e:	e9 1c f1 ff ff       	jmp    801068af <alltraps>
...
80107793:	6a 00                	push   $0x0
  pushl $249
80107795:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010779a:	e9 10 f1 ff ff       	jmp    801068af <alltraps>
...
8010779f:	6a 00                	push   $0x0
  pushl $250
801077a1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801077a6:	e9 04 f1 ff ff       	jmp    801068af <alltraps>
...
801077ab:	6a 00                	push   $0x0
  pushl $251
801077ad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801077b2:	e9 f8 f0 ff ff       	jmp    801068af <alltraps>
...
801077b7:	6a 00                	push   $0x0
  pushl $252
801077b9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801077be:	e9 ec f0 ff ff       	jmp    801068af <alltraps>
...
801077c3:	6a 00                	push   $0x0
  pushl $253
801077c5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801077ca:	e9 e0 f0 ff ff       	jmp    801068af <alltraps>
...
801077cf:	6a 00                	push   $0x0
  pushl $254
801077d1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801077d6:	e9 d4 f0 ff ff       	jmp    801068af <alltraps>
...
801077db:	6a 00                	push   $0x0
  pushl $255
801077dd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801077e2:	e9 c8 f0 ff ff       	jmp    801068af <alltraps>
801077e7:	66 90                	xchg   %ax,%ax
801077e9:	66 90                	xchg   %ax,%ax
801077eb:	66 90                	xchg   %ax,%ax
801077ed:	66 90                	xchg   %ax,%ax
801077ef:	90                   	nop
...
801077f6:	89 d3                	mov    %edx,%ebx
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
801077f8:	c1 ea 16             	shr    $0x16,%edx
801077fb:	8d 3c 90             	lea    (%eax,%edx,4),%edi
// Return the address of the PTE in page table pgdir
// that corresponds to virtual address va.  If alloc!=0,
// create any required page table pages.
static pte_t *
...
801077fe:	83 ec 0c             	sub    $0xc,%esp
  ...
  pde = &pgdir[PDX(va)];
  if(*pde & PTE_P){
80107801:	8b 07                	mov    (%edi),%eax
80107803:	a8 01                	test   $0x1,%al
80107805:	74 29                	je     80107830 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107807:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010780c:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
...
80107812:	8d 65 f4             	lea    -0xc(%ebp),%esp
  ...
  return &pgtab[PTX(va)];
80107815:	c1 eb 0a             	shr    $0xa,%ebx
80107818:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
8010781e:	8d 04 1e             	lea    (%esi,%ebx,1),%eax
}
80107821:	5b                   	pop    %ebx
80107822:	5e                   	pop    %esi
80107823:	5f                   	pop    %edi
...
80107832:	74 2c                	je     80107860 <walkpgdir+0x70>
80107834:	e8 f7 ad ff ff       	call   80102630 <kalloc>
80107839:	85 c0                	test   %eax,%eax
8010783b:	89 c6                	mov    %eax,%esi
8010783d:	74 21                	je     80107860 <walkpgdir+0x70>
      return 0;
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
8010783f:	83 ec 04             	sub    $0x4,%esp
80107842:	68 00 10 00 00       	push   $0x1000
80107847:	6a 00                	push   $0x0
80107849:	50                   	push   %eax
8010784a:	e8 61 d4 ff ff       	call   80104cb0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010784f:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80107855:	83 c4 10             	add    $0x10,%esp
80107858:	83 c8 07             	or     $0x7,%eax
8010785b:	89 07                	mov    %eax,(%edi)
8010785d:	eb b3                	jmp    80107812 <walkpgdir+0x22>
8010785f:	90                   	nop
  }
  return &pgtab[PTX(va)];
}
...
80107876:	89 d3                	mov    %edx,%ebx
80107878:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
// Create PTEs for virtual addresses starting at va that refer to
// physical addresses starting at pa. va and size might not
// be page-aligned.
static int
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
8010787e:	83 ec 1c             	sub    $0x1c,%esp
80107881:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107884:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80107888:	8b 7d 08             	mov    0x8(%ebp),%edi
8010788b:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107890:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(;;){
...
80107896:	29 df                	sub    %ebx,%edi
80107898:	83 c8 01             	or     $0x1,%eax
8010789b:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010789e:	eb 15                	jmp    801078b5 <mappages+0x45>
  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
801078a0:	f6 00 01             	testb  $0x1,(%eax)
801078a3:	75 45                	jne    801078ea <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
801078a5:	0b 75 dc             	or     -0x24(%ebp),%esi
    if(a == last)
801078a8:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
801078ab:	89 30                	mov    %esi,(%eax)
    if(a == last)
801078ad:	74 31                	je     801078e0 <mappages+0x70>
      break;
    a += PGSIZE;
801078af:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  pte_t *pte;
  ...
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801078b5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801078b8:	b9 01 00 00 00       	mov    $0x1,%ecx
801078bd:	89 da                	mov    %ebx,%edx
801078bf:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
801078c2:	e8 29 ff ff ff       	call   801077f0 <walkpgdir>
801078c7:	85 c0                	test   %eax,%eax
801078c9:	75 d5                	jne    801078a0 <mappages+0x30>
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
...
801078cb:	8d 65 f4             	lea    -0xc(%ebp),%esp
  ...
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
801078ce:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
...
801078ed:	68 20 8f 10 80       	push   $0x80108f20
801078f2:	e8 79 8a ff ff       	call   80100370 <panic>
801078f7:	89 f6                	mov    %esi,%esi
801078f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80107900 <deallocuvm.part.0>:
...
80107905:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80107906:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
...
8010790c:	89 c7                	mov    %eax,%edi
  ...
  a = PGROUNDUP(newsz);
8010790e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80107914:	83 ec 1c             	sub    $0x1c,%esp
80107917:	89 4d e0             	mov    %ecx,-0x20(%ebp)
...
8010791a:	39 d3                	cmp    %edx,%ebx
8010791c:	73 66                	jae    80107984 <deallocuvm.part.0+0x84>
8010791e:	89 d6                	mov    %edx,%esi
80107920:	eb 3d                	jmp    8010795f <deallocuvm.part.0+0x5f>
80107922:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80107928:	8b 10                	mov    (%eax),%edx
8010792a:	f6 c2 01             	test   $0x1,%dl
8010792d:	74 26                	je     80107955 <deallocuvm.part.0+0x55>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010792f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80107935:	74 58                	je     8010798f <deallocuvm.part.0+0x8f>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80107937:	83 ec 0c             	sub    $0xc,%esp
8010793a:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80107940:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107943:	52                   	push   %edx
80107944:	e8 37 ab ff ff       	call   80102480 <kfree>
      *pte = 0;
80107949:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010794c:	83 c4 10             	add    $0x10,%esp
8010794f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80107955:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010795b:	39 f3                	cmp    %esi,%ebx
8010795d:	73 25                	jae    80107984 <deallocuvm.part.0+0x84>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010795f:	31 c9                	xor    %ecx,%ecx
80107961:	89 da                	mov    %ebx,%edx
80107963:	89 f8                	mov    %edi,%eax
80107965:	e8 86 fe ff ff       	call   801077f0 <walkpgdir>
    if(!pte)
8010796a:	85 c0                	test   %eax,%eax
8010796c:	75 ba                	jne    80107928 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010796e:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80107974:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
8010797a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107980:	39 f3                	cmp    %esi,%ebx
80107982:	72 db                	jb     8010795f <deallocuvm.part.0+0x5f>
      kfree(v);
      *pte = 0;
    }
  }
...
80107984:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80107992:	68 e6 83 10 80       	push   $0x801083e6
...
801079a3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801079a6:	e8 85 bf ff ff       	call   80103930 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801079ab:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801079b1:	31 c9                	xor    %ecx,%ecx
801079b3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801079b8:	66 89 90 18 48 11 80 	mov    %dx,-0x7feeb7e8(%eax)
801079bf:	66 89 88 1a 48 11 80 	mov    %cx,-0x7feeb7e6(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801079c6:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801079cb:	31 c9                	xor    %ecx,%ecx
801079cd:	66 89 90 20 48 11 80 	mov    %dx,-0x7feeb7e0(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801079d4:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801079d9:	66 89 88 22 48 11 80 	mov    %cx,-0x7feeb7de(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801079e0:	31 c9                	xor    %ecx,%ecx
801079e2:	66 89 90 28 48 11 80 	mov    %dx,-0x7feeb7d8(%eax)
801079e9:	66 89 88 2a 48 11 80 	mov    %cx,-0x7feeb7d6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801079f0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801079f5:	31 c9                	xor    %ecx,%ecx
801079f7:	66 89 90 30 48 11 80 	mov    %dx,-0x7feeb7d0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801079fe:	c6 80 1c 48 11 80 00 	movb   $0x0,-0x7feeb7e4(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80107a05:	ba 2f 00 00 00       	mov    $0x2f,%edx
80107a0a:	c6 80 1d 48 11 80 9a 	movb   $0x9a,-0x7feeb7e3(%eax)
80107a11:	c6 80 1e 48 11 80 cf 	movb   $0xcf,-0x7feeb7e2(%eax)
80107a18:	c6 80 1f 48 11 80 00 	movb   $0x0,-0x7feeb7e1(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107a1f:	c6 80 24 48 11 80 00 	movb   $0x0,-0x7feeb7dc(%eax)
80107a26:	c6 80 25 48 11 80 92 	movb   $0x92,-0x7feeb7db(%eax)
80107a2d:	c6 80 26 48 11 80 cf 	movb   $0xcf,-0x7feeb7da(%eax)
80107a34:	c6 80 27 48 11 80 00 	movb   $0x0,-0x7feeb7d9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107a3b:	c6 80 2c 48 11 80 00 	movb   $0x0,-0x7feeb7d4(%eax)
80107a42:	c6 80 2d 48 11 80 fa 	movb   $0xfa,-0x7feeb7d3(%eax)
80107a49:	c6 80 2e 48 11 80 cf 	movb   $0xcf,-0x7feeb7d2(%eax)
80107a50:	c6 80 2f 48 11 80 00 	movb   $0x0,-0x7feeb7d1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107a57:	66 89 88 32 48 11 80 	mov    %cx,-0x7feeb7ce(%eax)
80107a5e:	c6 80 34 48 11 80 00 	movb   $0x0,-0x7feeb7cc(%eax)
80107a65:	c6 80 35 48 11 80 f2 	movb   $0xf2,-0x7feeb7cb(%eax)
80107a6c:	c6 80 36 48 11 80 cf 	movb   $0xcf,-0x7feeb7ca(%eax)
80107a73:	c6 80 37 48 11 80 00 	movb   $0x0,-0x7feeb7c9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80107a7a:	05 10 48 11 80       	add    $0x80114810,%eax
80107a7f:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
80107a83:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80107a87:	c1 e8 10             	shr    $0x10,%eax
80107a8a:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107a8e:	8d 45 f2             	lea    -0xe(%ebp),%eax
80107a91:	0f 01 10             	lgdtl  (%eax)
}
80107a94:	c9                   	leave  
80107a95:	c3                   	ret    
...
80107aa0:	a1 24 ee 12 80       	mov    0x8012ee24,%eax
...
80107ace:	0f 84 cd 00 00 00    	je     80107ba1 <switchuvm+0xe1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80107ad4:	8b 46 08             	mov    0x8(%esi),%eax
80107ad7:	85 c0                	test   %eax,%eax
80107ad9:	0f 84 dc 00 00 00    	je     80107bbb <switchuvm+0xfb>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80107adf:	8b 7e 04             	mov    0x4(%esi),%edi
80107ae2:	85 ff                	test   %edi,%edi
80107ae4:	0f 84 c4 00 00 00    	je     80107bae <switchuvm+0xee>
    panic("switchuvm: no pgdir");

  pushcli();
80107aea:	e8 61 ce ff ff       	call   80104950 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80107aef:	e8 bc bd ff ff       	call   801038b0 <mycpu>
80107af4:	89 c3                	mov    %eax,%ebx
80107af6:	e8 b5 bd ff ff       	call   801038b0 <mycpu>
80107afb:	89 c7                	mov    %eax,%edi
80107afd:	e8 ae bd ff ff       	call   801038b0 <mycpu>
80107b02:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107b05:	83 c7 08             	add    $0x8,%edi
80107b08:	e8 a3 bd ff ff       	call   801038b0 <mycpu>
80107b0d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80107b10:	83 c0 08             	add    $0x8,%eax
80107b13:	ba 67 00 00 00       	mov    $0x67,%edx
80107b18:	c1 e8 18             	shr    $0x18,%eax
80107b1b:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
80107b22:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80107b29:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
80107b30:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80107b37:	83 c1 08             	add    $0x8,%ecx
80107b3a:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80107b40:	c1 e9 10             	shr    $0x10,%ecx
80107b43:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
...
80107b49:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    panic("switchuvm: no pgdir");
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80107b4e:	e8 5d bd ff ff       	call   801038b0 <mycpu>
80107b53:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80107b5a:	e8 51 bd ff ff       	call   801038b0 <mycpu>
80107b5f:	b9 10 00 00 00       	mov    $0x10,%ecx
80107b64:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80107b68:	e8 43 bd ff ff       	call   801038b0 <mycpu>
80107b6d:	8b 56 08             	mov    0x8(%esi),%edx
80107b70:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
80107b76:	89 48 0c             	mov    %ecx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107b79:	e8 32 bd ff ff       	call   801038b0 <mycpu>
80107b7e:	66 89 58 6e          	mov    %bx,0x6e(%eax)
}
...
80107b82:	b8 28 00 00 00       	mov    $0x28,%eax
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80107b8a:	8b 46 04             	mov    0x4(%esi),%eax
80107b8d:	05 00 00 00 80       	add    $0x80000000,%eax
80107b92:	0f 22 d8             	mov    %eax,%cr3
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
}
80107b95:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107b98:	5b                   	pop    %ebx
80107b99:	5e                   	pop    %esi
80107b9a:	5f                   	pop    %edi
80107b9b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80107b9c:	e9 ef cd ff ff       	jmp    80104990 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80107ba4:	68 26 8f 10 80       	push   $0x80108f26
80107ba9:	e8 c2 87 ff ff       	call   80100370 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
80107bae:	83 ec 0c             	sub    $0xc,%esp
80107bb1:	68 51 8f 10 80       	push   $0x80108f51
80107bb6:	e8 b5 87 ff ff       	call   80100370 <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80107bbb:	83 ec 0c             	sub    $0xc,%esp
80107bbe:	68 3c 8f 10 80       	push   $0x80108f3c
80107bc3:	e8 a8 87 ff ff       	call   80100370 <panic>
80107bc8:	90                   	nop
...
80107bd9:	8b 75 10             	mov    0x10(%ebp),%esi
80107bdc:	8b 45 08             	mov    0x8(%ebp),%eax
80107bdf:	8b 7d 0c             	mov    0xc(%ebp),%edi
  char *mem;

  if(sz >= PGSIZE)
80107be2:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
...
inituvm(pde_t *pgdir, char *init, uint sz)
{
80107be8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  char *mem;

  if(sz >= PGSIZE)
80107beb:	77 49                	ja     80107c36 <inituvm+0x66>
    panic("inituvm: more than a page");
  mem = kalloc();
80107bed:	e8 3e aa ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
...
80107bf5:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80107bf7:	68 00 10 00 00       	push   $0x1000
80107bfc:	6a 00                	push   $0x0
80107bfe:	50                   	push   %eax
80107bff:	e8 ac d0 ff ff       	call   80104cb0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107c04:	58                   	pop    %eax
80107c05:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107c0b:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107c10:	5a                   	pop    %edx
80107c11:	6a 06                	push   $0x6
80107c13:	50                   	push   %eax
80107c14:	31 d2                	xor    %edx,%edx
80107c16:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107c19:	e8 52 fc ff ff       	call   80107870 <mappages>
  memmove(mem, init, sz);
80107c1e:	89 75 10             	mov    %esi,0x10(%ebp)
80107c21:	89 7d 0c             	mov    %edi,0xc(%ebp)
80107c24:	83 c4 10             	add    $0x10,%esp
80107c27:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80107c30:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80107c31:	e9 2a d1 ff ff       	jmp    80104d60 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80107c39:	68 65 8f 10 80       	push   $0x80108f65
80107c3e:	e8 2d 87 ff ff       	call   80100370 <panic>
80107c43:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80107c59:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
80107c60:	0f 85 91 00 00 00    	jne    80107cf7 <loaduvm+0xa7>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80107c66:	8b 75 18             	mov    0x18(%ebp),%esi
80107c69:	31 db                	xor    %ebx,%ebx
80107c6b:	85 f6                	test   %esi,%esi
80107c6d:	75 1a                	jne    80107c89 <loaduvm+0x39>
80107c6f:	eb 6f                	jmp    80107ce0 <loaduvm+0x90>
80107c71:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107c78:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107c7e:	81 ee 00 10 00 00    	sub    $0x1000,%esi
80107c84:	39 5d 18             	cmp    %ebx,0x18(%ebp)
80107c87:	76 57                	jbe    80107ce0 <loaduvm+0x90>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107c89:	8b 55 0c             	mov    0xc(%ebp),%edx
80107c8c:	8b 45 08             	mov    0x8(%ebp),%eax
80107c8f:	31 c9                	xor    %ecx,%ecx
80107c91:	01 da                	add    %ebx,%edx
80107c93:	e8 58 fb ff ff       	call   801077f0 <walkpgdir>
80107c98:	85 c0                	test   %eax,%eax
80107c9a:	74 4e                	je     80107cea <loaduvm+0x9a>
...
80107c9e:	8b 4d 14             	mov    0x14(%ebp),%ecx
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
    pa = PTE_ADDR(*pte);
    if(sz - i < PGSIZE)
80107ca1:	bf 00 10 00 00       	mov    $0x1000,%edi
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
    pa = PTE_ADDR(*pte);
80107ca6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80107cab:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80107cb1:	0f 46 fe             	cmovbe %esi,%edi
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, P2V(pa), offset+i, n) != n)
80107cb4:	01 d9                	add    %ebx,%ecx
80107cb6:	05 00 00 00 80       	add    $0x80000000,%eax
80107cbb:	57                   	push   %edi
80107cbc:	51                   	push   %ecx
80107cbd:	50                   	push   %eax
80107cbe:	ff 75 10             	pushl  0x10(%ebp)
80107cc1:	e8 2a 9e ff ff       	call   80101af0 <readi>
80107cc6:	83 c4 10             	add    $0x10,%esp
80107cc9:	39 c7                	cmp    %eax,%edi
80107ccb:	74 ab                	je     80107c78 <loaduvm+0x28>
      return -1;
  }
  return 0;
}
...
80107ced:	68 7f 8f 10 80       	push   $0x80108f7f
80107cf2:	e8 79 86 ff ff       	call   80100370 <panic>
{
  uint i, pa, n;
  pte_t *pte;
...
80107cfa:	68 20 90 10 80       	push   $0x80109020
80107cff:	e8 6c 86 ff ff       	call   80100370 <panic>
80107d04:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80107d0a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
80107d19:	8b 7d 10             	mov    0x10(%ebp),%edi
  char *mem;
  uint a;

  if(newsz >= KERNBASE)
80107d1c:	85 ff                	test   %edi,%edi
80107d1e:	0f 88 ca 00 00 00    	js     80107dee <allocuvm+0xde>
    return 0;
  if(newsz < oldsz)
80107d24:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80107d27:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80107d2a:	0f 82 82 00 00 00    	jb     80107db2 <allocuvm+0xa2>
    return oldsz;

  a = PGROUNDUP(oldsz);
80107d30:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80107d36:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80107d3c:	39 df                	cmp    %ebx,%edi
80107d3e:	77 43                	ja     80107d83 <allocuvm+0x73>
80107d40:	e9 bb 00 00 00       	jmp    80107e00 <allocuvm+0xf0>
...
80107d53:	e8 58 cf ff ff       	call   80104cb0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107d58:	58                   	pop    %eax
80107d59:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80107d5f:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107d64:	5a                   	pop    %edx
80107d65:	6a 06                	push   $0x6
80107d67:	50                   	push   %eax
80107d68:	89 da                	mov    %ebx,%edx
80107d6a:	8b 45 08             	mov    0x8(%ebp),%eax
80107d6d:	e8 fe fa ff ff       	call   80107870 <mappages>
80107d72:	83 c4 10             	add    $0x10,%esp
80107d75:	85 c0                	test   %eax,%eax
80107d77:	78 47                	js     80107dc0 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80107d79:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107d7f:	39 df                	cmp    %ebx,%edi
80107d81:	76 7d                	jbe    80107e00 <allocuvm+0xf0>
    mem = kalloc();
80107d83:	e8 a8 a8 ff ff       	call   80102630 <kalloc>
    if(mem == 0){
80107d88:	85 c0                	test   %eax,%eax
  ...
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
80107d8a:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80107d8c:	75 ba                	jne    80107d48 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80107d8e:	83 ec 0c             	sub    $0xc,%esp
80107d91:	68 9d 8f 10 80       	push   $0x80108f9d
80107d96:	e8 45 89 ff ff       	call   801006e0 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80107d9e:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80107da1:	76 4b                	jbe    80107dee <allocuvm+0xde>
80107da3:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107da6:	8b 45 08             	mov    0x8(%ebp),%eax
80107da9:	89 fa                	mov    %edi,%edx
80107dab:	e8 50 fb ff ff       	call   80107900 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80107db2:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107db5:	5b                   	pop    %ebx
80107db6:	5e                   	pop    %esi
80107db7:	5f                   	pop    %edi
80107db8:	5d                   	pop    %ebp
...
80107dc3:	68 b5 8f 10 80       	push   $0x80108fb5
80107dc8:	e8 13 89 ff ff       	call   801006e0 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
...
80107dd0:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80107dd3:	76 0d                	jbe    80107de2 <allocuvm+0xd2>
80107dd5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107dd8:	8b 45 08             	mov    0x8(%ebp),%eax
80107ddb:	89 fa                	mov    %edi,%edx
80107ddd:	e8 1e fb ff ff       	call   80107900 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80107de5:	56                   	push   %esi
80107de6:	e8 95 a6 ff ff       	call   80102480 <kfree>
      return 0;
...
80107e20:	5d                   	pop    %ebp
80107e21:	e9 da fa ff ff       	jmp    80107900 <deallocuvm.part.0>
...
80107e4e:	74 59                	je     80107ea9 <freevm+0x69>
80107e50:	31 c9                	xor    %ecx,%ecx
80107e52:	ba 00 00 00 80       	mov    $0x80000000,%edx
80107e57:	89 f0                	mov    %esi,%eax
80107e59:	e8 a2 fa ff ff       	call   80107900 <deallocuvm.part.0>
80107e5e:	89 f3                	mov    %esi,%ebx
...
80107e75:	74 23                	je     80107e9a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
...
80107e85:	83 c3 04             	add    $0x4,%ebx
80107e88:	05 00 00 00 80       	add    $0x80000000,%eax
80107e8d:	50                   	push   %eax
80107e8e:	e8 ed a5 ff ff       	call   80102480 <kfree>
80107e93:	83 c4 10             	add    $0x10,%esp
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107e96:	39 fb                	cmp    %edi,%ebx
80107e98:	75 dd                	jne    80107e77 <freevm+0x37>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
80107e9a:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80107ea3:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80107ea4:	e9 d7 a5 ff ff       	jmp    80102480 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80107eac:	68 d1 8f 10 80       	push   $0x80108fd1
80107eb1:	e8 ba 84 ff ff       	call   80100370 <panic>
80107eb6:	8d 76 00             	lea    0x0(%esi),%esi
...
80107ec5:	e8 66 a7 ff ff       	call   80102630 <kalloc>
80107eca:	85 c0                	test   %eax,%eax
80107ecc:	74 6a                	je     80107f38 <setupkvm+0x78>
    return 0;
  memset(pgdir, 0, PGSIZE);
80107ece:	83 ec 04             	sub    $0x4,%esp
80107ed1:	89 c6                	mov    %eax,%esi
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107ed3:	bb 20 c4 10 80       	mov    $0x8010c420,%ebx
  pde_t *pgdir;
  struct kmap *k;
...
80107ee0:	e8 cb cd ff ff       	call   80104cb0 <memset>
...
80107eeb:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107eee:	83 ec 08             	sub    $0x8,%esp
80107ef1:	8b 13                	mov    (%ebx),%edx
80107ef3:	ff 73 0c             	pushl  0xc(%ebx)
80107ef6:	50                   	push   %eax
80107ef7:	29 c1                	sub    %eax,%ecx
80107ef9:	89 f0                	mov    %esi,%eax
80107efb:	e8 70 f9 ff ff       	call   80107870 <mappages>
80107f00:	83 c4 10             	add    $0x10,%esp
80107f03:	85 c0                	test   %eax,%eax
80107f05:	78 19                	js     80107f20 <setupkvm+0x60>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107f07:	83 c3 10             	add    $0x10,%ebx
80107f0a:	81 fb 60 c4 10 80    	cmp    $0x8010c460,%ebx
80107f10:	75 d6                	jne    80107ee8 <setupkvm+0x28>
80107f12:	89 f0                	mov    %esi,%eax
...
80107f14:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107f17:	5b                   	pop    %ebx
80107f18:	5e                   	pop    %esi
80107f19:	5d                   	pop    %ebp
80107f1a:	c3                   	ret    
...
80107f23:	56                   	push   %esi
80107f24:	e8 17 ff ff ff       	call   80107e40 <freevm>
      return 0;
80107f29:	83 c4 10             	add    $0x10,%esp
    }
  return pgdir;
}
80107f2c:	8d 65 f8             	lea    -0x8(%ebp),%esp
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
...
80107f35:	8d 76 00             	lea    0x0(%esi),%esi
{
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
80107f38:	31 c0                	xor    %eax,%eax
80107f3a:	eb d8                	jmp    80107f14 <setupkvm+0x54>
...
80107f4b:	a3 24 ee 12 80       	mov    %eax,0x8012ee24
...
80107f6e:	e8 7d f8 ff ff       	call   801077f0 <walkpgdir>
  if(pte == 0)
...
80107f7f:	68 e2 8f 10 80       	push   $0x80108fe2
80107f84:	e8 e7 83 ff ff       	call   80100370 <panic>
...
80107fa3:	0f 84 c5 00 00 00    	je     8010806e <copyuvm+0xde>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107fa9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107fac:	85 c9                	test   %ecx,%ecx
80107fae:	0f 84 9c 00 00 00    	je     80108050 <copyuvm+0xc0>
80107fb4:	31 ff                	xor    %edi,%edi
80107fb6:	eb 4a                	jmp    80108002 <copyuvm+0x72>
80107fb8:	90                   	nop
...
80107fc3:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80107fc9:	68 00 10 00 00       	push   $0x1000
80107fce:	53                   	push   %ebx
80107fcf:	50                   	push   %eax
80107fd0:	e8 8b cd ff ff       	call   80104d60 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80107fd5:	58                   	pop    %eax
80107fd6:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80107fdc:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107fe1:	5a                   	pop    %edx
80107fe2:	ff 75 e4             	pushl  -0x1c(%ebp)
80107fe5:	50                   	push   %eax
80107fe6:	89 fa                	mov    %edi,%edx
80107fe8:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107feb:	e8 80 f8 ff ff       	call   80107870 <mappages>
80107ff0:	83 c4 10             	add    $0x10,%esp
80107ff3:	85 c0                	test   %eax,%eax
80107ff5:	78 69                	js     80108060 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107ff7:	81 c7 00 10 00 00    	add    $0x1000,%edi
80107ffd:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80108000:	76 4e                	jbe    80108050 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108002:	8b 45 08             	mov    0x8(%ebp),%eax
80108005:	31 c9                	xor    %ecx,%ecx
80108007:	89 fa                	mov    %edi,%edx
80108009:	e8 e2 f7 ff ff       	call   801077f0 <walkpgdir>
8010800e:	85 c0                	test   %eax,%eax
80108010:	74 6d                	je     8010807f <copyuvm+0xef>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80108012:	8b 00                	mov    (%eax),%eax
80108014:	a8 01                	test   $0x1,%al
80108016:	74 5a                	je     80108072 <copyuvm+0xe2>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
8010801f:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    flags = PTE_FLAGS(*pte);
80108025:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80108028:	e8 03 a6 ff ff       	call   80102630 <kalloc>
8010802d:	85 c0                	test   %eax,%eax
8010802f:	89 c6                	mov    %eax,%esi
80108031:	75 8d                	jne    80107fc0 <copyuvm+0x30>
    }
  }
  return d;
...
80108036:	ff 75 e0             	pushl  -0x20(%ebp)
80108039:	e8 02 fe ff ff       	call   80107e40 <freevm>
  return 0;
8010803e:	83 c4 10             	add    $0x10,%esp
80108041:	31 c0                	xor    %eax,%eax
}
...
8010804c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108050:	8b 45 e0             	mov    -0x20(%ebp),%eax
  return d;
...
80108064:	e8 17 a4 ff ff       	call   80102480 <kfree>
      goto bad;
80108069:	83 c4 10             	add    $0x10,%esp
8010806c:	eb c5                	jmp    80108033 <copyuvm+0xa3>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
8010806e:	31 c0                	xor    %eax,%eax
80108070:	eb d1                	jmp    80108043 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80108075:	68 06 90 10 80       	push   $0x80109006
8010807a:	e8 f1 82 ff ff       	call   80100370 <panic>
...
80108082:	68 ec 8f 10 80       	push   $0x80108fec
80108087:	e8 e4 82 ff ff       	call   80100370 <panic>
...
8010809e:	e8 4d f7 ff ff       	call   801077f0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
801080b4:	c9                   	leave  
  ...
  if((*pte & PTE_U) == 0)
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
801080b5:	05 00 00 00 80       	add    $0x80000000,%eax
}
801080ba:	c3                   	ret    
801080bb:	90                   	nop
...
801080d9:	8b 5d 14             	mov    0x14(%ebp),%ebx
801080dc:	8b 55 0c             	mov    0xc(%ebp),%edx
801080df:	8b 7d 10             	mov    0x10(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
801080e2:	85 db                	test   %ebx,%ebx
801080e4:	75 40                	jne    80108126 <copyout+0x56>
801080e6:	eb 70                	jmp    80108158 <copyout+0x88>
801080e8:	90                   	nop
...
801080f3:	89 f1                	mov    %esi,%ecx
801080f5:	29 d1                	sub    %edx,%ecx
801080f7:	81 c1 00 10 00 00    	add    $0x1000,%ecx
801080fd:	39 d9                	cmp    %ebx,%ecx
801080ff:	0f 47 cb             	cmova  %ebx,%ecx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80108102:	29 f2                	sub    %esi,%edx
80108104:	83 ec 04             	sub    $0x4,%esp
80108107:	01 d0                	add    %edx,%eax
80108109:	51                   	push   %ecx
8010810a:	57                   	push   %edi
8010810b:	50                   	push   %eax
8010810c:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
8010810f:	e8 4c cc ff ff       	call   80104d60 <memmove>
    len -= n;
    buf += n;
80108114:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
{
  char *buf, *pa0;
  uint n, va0;
...
80108117:	83 c4 10             	add    $0x10,%esp
    ...
    buf += n;
    va = va0 + PGSIZE;
8010811a:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
    n = PGSIZE - (va - va0);
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
...
80108120:	01 cf                	add    %ecx,%edi
{
  ...
  buf = (char*)p;
  while(len > 0){
80108122:	29 cb                	sub    %ecx,%ebx
80108124:	74 32                	je     80108158 <copyout+0x88>
    va0 = (uint)PGROUNDDOWN(va);
80108126:	89 d6                	mov    %edx,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80108128:	83 ec 08             	sub    $0x8,%esp
  ...
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
8010812b:	89 55 e4             	mov    %edx,-0x1c(%ebp)
8010812e:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80108134:	56                   	push   %esi
80108135:	ff 75 08             	pushl  0x8(%ebp)
80108138:	e8 53 ff ff ff       	call   80108090 <uva2ka>
    if(pa0 == 0)
...
80108144:	8d 65 f4             	lea    -0xc(%ebp),%esp
  buf = (char*)p;
  while(len > 0){
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
...
80108158:	8d 65 f4             	lea    -0xc(%ebp),%esp
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
