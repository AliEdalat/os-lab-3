...
main(void)
{
  ...
  ab:	68 fb 07 00 00       	push   $0x7fb
  b0:	e8 b5 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 fe 07 00 00       	push   $0x7fe
  bc:	6a 01                	push   $0x1
...
000003ea <sort_syscalls>:
SYSCALL(sort_syscalls)
 3ea:	b8 19 00 00 00       	mov    $0x19,%eax
 3ef:	cd 40                	int    $0x40
 3f1:	c3                   	ret    

000003f2 <log_syscalls>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 6c 08 00 00 	movzbl 0x86c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5d8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5db:	b8 64 08 00 00       	mov    $0x864,%eax
...
free(void *ap)
{
 ...
 6da:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6dd:	a3 10 0b 00 00       	mov    %eax,0xb10
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 79c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 79f:	89 15 10 0b 00 00    	mov    %edx,0xb10
      return (void*)(p + 1);
 ...
 7b4:	eb e9                	jmp    79f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 10 0b 00 00 14 	movl   $0xb14,0xb10
 7bd:	0b 00 00 
 7c0:	c7 05 14 0b 00 00 14 	movl   $0xb14,0xb14
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 14 0b 00 00       	mov    $0xb14,%eax
 7cf:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 7d6:	00 00 00 
