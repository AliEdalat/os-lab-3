...
000003fa <sort_syscalls>:
SYSCALL(sort_syscalls)
 3fa:	b8 19 00 00 00       	mov    $0x19,%eax
 3ff:	cd 40                	int    $0x40
 401:	c3                   	ret    

00000402 <log_syscalls>:
 ...
 439:	85 d2                	test   %edx,%edx
{
 ...
 467:	f7 f1                	div    %ecx
 469:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb ac 08 00 00       	mov    $0x8ac,%ebx
        while(*s != 0){
 ...
 6a1:	a1 64 0b 00 00       	mov    0xb64,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 64 0b 00 00    	cmp    %eax,0xb64
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 64 0b 00 00    	mov    0xb64,%edx
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 64 0b 00 00    	mov    %edx,0xb64
}
 ...
 7f7:	0b 00 00 
 7fa:	c7 05 68 0b 00 00 68 	movl   $0xb68,0xb68
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 68 0b 00 00       	mov    $0xb68,%eax
